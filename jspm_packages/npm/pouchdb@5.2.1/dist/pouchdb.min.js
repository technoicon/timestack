      ...
      4: [function(e, t, n) {
        ...
        t.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function(e) {
          ...
          if (o(n))
            ...
            for (i = Array.prototype.slice.call(arguments, 1), c = n.slice(), r = c.length, u = 0; r > u; u++)
              c[u].apply(this, i);
          return !0;
      ...
      14: [function(e, t, n) {
        (function() {
          ...
          t.exports = function(t, r) {
            ...
            i = [], s = [];
            for (o in r)
              e.call(r, o) && (a = r[o], "this" !== o && (i.push(o), s.push(a)));
        ...
        !function(t) {
          ...
          return "5d41402abc4b2a76b9719d911017c592" !== d(c("hello")) && (g = function(e, t) {
            ...
            if (e[i >> 2] |= 128 << (i % 4 << 3), i > 55)
              for (a(this._hash, e), i = 0; 16 > i; i += 1)
                e[i] = 0;
        ...
        n.stringify = function(e) {
          ...
          for (var n,
            ...
            if (r = n.obj, o = n.prefix || "", i = n.val || "", h += o, i)
              ...
              h += "undefined" == typeof r ? null : JSON.stringify(r);
            else if (null === r)
              h += "null";
          ...
          for (var t,
              ...
              d = [],
              h = 0; ; )
            if (t = e[h++], "}" !== t && "]" !== t && "undefined" != typeof t)
              switch (t) {
                case " ":
                case "	":
                case "\n":
      ...
      17: [function(e, t, n) {
        (function(n, r) {
            ...
            function n(e, t, n) {
              if (sr.enabled) {
                ...
                n[n.length - 1] = function(n, r) {
                  var o = [e._db_name, t];
                  o = o.concat(n ? ["error", n] : ["success", r]), sr.apply(null, o), i(n, r);
                };
              }
            }
            return l(Yn(function(r) {
              if (this._closed)
                return ar.reject(new Error("database is closed"));
              var o = this;
              return n(o, e, r), this.taskqueue.isReady ? t.apply(this, r) : new ar(function(t, n) {
          ...
          function h(e, t, n) {
            return new ar(function(r, o) {
              e.get(t, function(i, a) {
                ...
                var s = a._rev,
                    u = n(a);
                return u ? (u._id = t, u._rev = s, void r(p(e, u, n))) : r({
                  updated: !1,
                  rev: s
                });
              });
          ...
          function A(e, t, n) {
            ...
            return r.prototype = x.prototype, new r(t);
          }
          function T(e) {
            var t,
                n,
                ...
                o,
                i;
            return n = e.error === !0 && "string" == typeof e.name ? e.name : e.error, i = e.reason, r = Ir("name", n, i), e.missing || "missing" === i || "deleted" === i || "not_found" === n ? r = fr : "doc_validation" === n ? (r = br, o = i) : "bad_request" === n && r.message !== i && (r = wr), r || (r = Ir("status", e.status, i) || yr), t = A(r, i, n), o && (t.message = o), e.id && (t.id = e.id), e.status && (t.status = e.status), e.missing && (t.missing = e.missing), t;
          }
          function O(e, t, n) {
            function r() {
              o.cancel();
            ...
            var o = this;
            this.db = e, t = t ? c(t) : {};
            var i = t.complete = f(function(t, n) {
          ...
          function j(e, t, n) {
            var r = [{rev: e._rev}];
            "all_docs" === n.style && (r = k(t.rev_tree).map(function(e) {
              return {rev: e.rev};
            }));
            var o = {
              id: t.id,
            ...
            return _(t, e._rev) && (o.deleted = !0), n.conflicts && (o.doc._conflicts = q(t), o.doc._conflicts.length || delete o.doc._conflicts), o;
          }
          function C(e, t, n) {
            function r() {
              var e = [];
            ...
            var s = Array.isArray(t) ? t : t.docs,
                u = {};
            ...
            Object.keys(u).forEach(function(n, r) {
              var o = u[n],
                  s = i(o[0], ["atts_since", "attachments"]);
              s.open_revs = o.map(function(e) {
                return e.rev;
              }), s.open_revs = s.open_revs.filter(function(e) {
                return e;
              });
              var c = function(e) {
                return e;
              };
              0 === s.open_revs.length && (delete s.open_revs, c = function(e) {
                return [{ok: e}];
              }), ["revs", "attachments", "binary"].forEach(function(e) {
                e in t && (s[e] = t[e]);
              }), e.get(n, s, function(e, t) {
                a(r, n, e ? [{error: e}] : c(t));
              });
            });
          }
          ...
          function B(e) {
            var t;
            if (e ? "string" != typeof e ? t = A(dr) : /^_/.test(e) && !/^_(design|local)/.test(e) && (t = A(pr)) : t = A(hr), t)
              throw t;
          }
          function F(e) {
            if (!/^\d+\-./.test(e))
          ...
          function U(e, t) {
            ...
            if (e._deleted && (i.deleted = !0), t)
              if (e._id || (e._id = D()), r = D(32, 16).toLowerCase(), e._rev) {
                if (o = F(e._rev), o.error)
                  return o;
                e._rev_tree = [{
                  pos: o.prefix,
            ...
            else if (e._revisions && (e._rev_tree = M(e._revisions, i), n = e._revisions.start, r = e._revisions.ids[0]), !e._rev_tree) {
              if (o = F(e._rev), o.error)
                return o;
            ...
            for (var s in e)
              if (Object.prototype.hasOwnProperty.call(e, s)) {
                ...
                if (u && !Dr[s]) {
                  var c = A(br, s);
                  throw c.message = br.message + ": " + s, c;
                }
            ...
            for (var t = 0; t < e.length; t++) {
              ...
              if (n._deleted)
                ...
                for (var r = Object.keys(n._attachments),
                    o = 0; o < r.length; o++) {
                  var a = r[o];
                  n._attachments[a] = i(n._attachments[a], ["data", "digest", "content_type", "length", "revpos", "stub"]);
                }
            }
          }
          function K(e, t) {
          ...
          function V(e, t, n) {
            ...
            var o = {offset: t.skip};
            return ar.all(r.map(function(n) {
              var r = Vn.extend({
                key: n,
                deleted: "ok"
              }, t);
            ...
            e.get("_local/compaction")["catch"](function() {
              ...
              t && t.last_seq && (r.last_seq = t.last_seq), e._compact(r, function(t, r) {
                t ? o(t) : o(null, r), n.nextTick(function() {
                  e._compactionQueue.shift(), e._compactionQueue.length && X(e);
                });
              });
            });
          }
          ...
          function ee(e, t, n) {
            if (!(this instanceof ee))
              return new ee(e, t, n);
            var r = this;
            ("function" == typeof t || "undefined" == typeof t) && (n = t, t = {}), e && "object" == typeof e && (t = e, e = void 0), "undefined" == typeof n && (n = Y), e = e || t.name, t = c(t), delete t.name, this.__opts = t;
            var o = n;
            r.auto_compaction = t.auto_compaction, r.prefix = ee.prefix, Q.call(r), r.taskqueue = new $;
            var i = new ar(function(o, i) {
              n = function(e, t) {
              ...
              return function() {
                try {
                  ...
                  if (a = ee.parseAdapter(u, t), t.originalName = u, t.name = a.name, t.prefix && "http" !== a.adapter && "https" !== a.adapter && (t.name = t.prefix + t.name), t.adapter = t.adapter || a.adapter, r._adapter = t.adapter, Zn("pouchdb:adapter")("Picked adapter: " + t.adapter), r._db_name = u, !ee.adapters[t.adapter])
                    throw s = new Error("Adapter is missing"), s.code = 404, s;
                  if (!ee.adapters[t.adapter].valid())
              ...
              }, r.replicate.sync = r.sync, void ee.adapters[t.adapter].call(r, t, function(e) {
                return e ? (r.taskqueue.fail(e), void n(e)) : (Z(r, t), r.emit("created", r), ee.emit("created", t.originalName), r.taskqueue.ready(r), void n(null, r));
              }));
            });
            i.then(function(e) {
              o(null, e);
          ...
          function re(e) {
            Object.keys($n.EventEmitter.prototype).forEach(function(t) {
              "function" == typeof $n.EventEmitter.prototype[t] && (e[t] = Mr[t].bind(Mr));
            });
            var t = e._destructionListeners = new Qn.Map;
          ...
          function ae() {
            for (var e = {},
                t = new ar(function(t, n) {
                  e.resolve = t, e.reject = n;
                }),
                n = new Array(arguments.length),
                r = 0; r < n.length; r++)
              n[r] = arguments[r];
            return e.promise = t, ar.resolve().then(function() {
          ...
          function se(e, t) {
            ...
            return e.json && (i.set("Accept", "application/json"), i.set("Content-Type", e.headers["Content-Type"] || "application/json")), e.body && e.body instanceof Blob ? ie(e.body, function(e) {
              a.body = e;
            ...
            }), n = ae(e.url, a), e.timeout > 0 && (r = setTimeout(function() {
          ...
          function ue(e, t) {
            ...
            for (var a in e.headers)
              e.headers.hasOwnProperty(a) && n.setRequestHeader(a, e.headers[a]);
            return e.timeout > 0 && (r = setTimeout(o, e.timeout), n.onprogress = function() {
              clearTimeout(r), r = setTimeout(o, e.timeout);
            }, "undefined" != typeof n.upload && (n.upload.onprogress = n.onprogress)), n.onreadystatechange = function() {
              if (4 === n.readyState) {
                var r = {statusCode: n.status};
                if (n.status >= 200 && n.status < 300) {
                  var o;
                  o = e.binary ? oe([n.response || ""], {type: n.getResponseHeader("Content-Type")}) : n.responseText, t(null, r, o);
                } else {
                  var i = {};
                  try {
            ...
            }, e.body && e.body instanceof Blob ? ie(e.body, function(e) {
              n.send(e);
            }) : n.send(e.body), {abort: o};
          }
          function ce() {
            try {
          ...
          function de(e, t) {
            function n(t, n, r) {
              ...
              Array.isArray(t) && (t = t.map(function(e) {
                return e.error || e.missing ? T(e) : e;
              })), e.binary && Pr(t, n), r(null, t, n);
            }
            function r(e, t) {
              var n,
                  r;
              ...
              try {
                n = JSON.parse(e.responseText), r = T(n);
              } catch (i) {
                r = T(e);
              }
              t(r);
            ...
            return e = Vn.extend(o, e), e.json && (e.binary || (e.headers.Accept = "application/json"), e.headers["Content-Type"] = e.headers["Content-Type"] || "application/json"), e.binary && (e.encoding = null, e.json = !1), e.processData || (e.json = !1), fe(e, function(o, i, a) {
              if (o)
              ...
              i.statusCode >= 200 && i.statusCode < 300 ? n(c, i, t) : (s = T(c), s.status = i.statusCode, t(s));
            });
          }
          function he(e, t) {
          ...
          function be(e, t, n, r, o) {
            return e.get(t)["catch"](function(n) {
              if (404 === n.status)
                return "http" === e.type() && ge(404, "PouchDB is just checking if a remote checkpoint exists."), {
                  session_id: r,
                  _id: t,
                  history: [],
                  replicator: Yr,
              ...
              return o.cancelled ? void 0 : (i.history = (i.history || []).filter(function(e) {
                ...
                last_seq: n,
                session_id: r
              }), i.history = i.history.slice(0, Zr), i.version = $r, i.replicator = Yr, i.session_id = r, i.last_seq = n, e.put(i)["catch"](function(i) {
                if (409 === i.status)
                  return be(e, t, n, r, o);
                throw i;
              }));
          ...
          function ke(e, t) {
            var n = t[0],
                r = t.slice(1);
            return e && 0 !== t.length ? e === n.session_id ? !0 : ke(e, r) : !1;
          }
          function qe(e) {
          ...
          function Ae(e) {
            var t = 0;
            return e || (t = 2e3), xe(e, t);
          }
          function Te(e, t, n, r) {
            return e.retry === !1 ? (t.emit("error", n), void t.removeAllListeners()) : ("function" != typeof e.back_off_function && (e.back_off_function = Ae), t.emit("requestError", n), ("active" === t.state || "pending" === t.state) && (t.emit("paused", n), t.state = "stopped", t.once("active", function() {
              e.current_back_off = no;
            })), e.current_back_off = e.current_back_off || no, e.current_back_off = e.back_off_function(e.current_back_off), void setTimeout(r, e.current_back_off));
          }
          function Oe(e) {
            return Vr(e);
          }
          ...
          function Le(e) {
            return Object.keys(e).sort(er.collate).reduce(function(t, n) {
              return t[n] = e[n], t;
            }, {});
          }
          function Ie(e, t, n) {
            var r = n.doc_ids ? n.doc_ids.sort(er.collate) : "",
                o = n.filter ? n.filter.toString() : "",
                i = "",
                a = "";
            return n.filter && n.query_params && (i = JSON.stringify(Le(n.query_params))), n.filter && "_view" === n.filter && (a = n.view.toString()), ar.all([e.id(), t.id()]).then(function(e) {
          ...
          function Ne(e, t, n) {
            ...
            function i(r) {
              return e.allDocs({
                ...
                e.rows.forEach(function(e) {
                  !e.deleted && e.doc && Re(e.value.rev) && !o(e.doc) && (u.push(e.doc), delete t[e.id]);
                });
              });
            }
            function a() {
            ...
            t = c(t);
            var u = [];
            return ar.resolve().then(a).then(r).then(s);
          }
          function Be(e, t, n, r, o) {
            function i() {
              return S ? ar.resolve() : Ie(e, t, n).then(function(n) {
                E = n, S = new we(e, t, E, r);
              });
            }
            function a() {
              if (B = [], 0 !== w.docs.length) {
                var e = w.docs;
                return t.bulkDocs({
                  docs: e,
                  new_edits: !1
                  ...
                  }), N = N.concat(n), o.docs_written += w.docs.length - n.length;
                  var a = n.filter(function(e) {
                    return "unauthorized" !== e.name && "forbidden" !== e.name;
                  });
                  if (e.forEach(function(e) {
                    var t = i[e._id];
                    t ? r.emit("denied", c(t)) : B.push(e);
                  }), a.length > 0) {
                    var s = new Error("bulkDocs error");
                    throw s.other_errors = n, h("target.bulkDocs failed to write docs", s), new Error("bulkWrite partial failure");
                  }
                }, function(t) {
            ...
            function s() {
              o.last_seq = O = w.seq;
              var e = c(o);
              return B.length && (e.docs = B, r.emit("change", e)), x = !0, S.writeCheckpoint(w.seq, F).then(function() {
                if (x = !1, r.cancelled)
                  throw p(), new Error("cancelled");
                w = void 0, m();
              })["catch"](function(e) {
                throw x = !1, h("writeCheckpoint completed with error", e), e;
              });
            }
            function u() {
              var e = {};
            ...
            function f() {
              return Ne(e, w.diffs, r).then(function(e) {
            ...
            function l() {
              if (!r.cancelled && !w) {
                if (0 === k.length)
                  return void d(!0);
                w = k.shift(), u().then(f).then(a).then(s).then(l)["catch"](function(e) {
                  h("batch processing terminated with error", e);
                });
              }
            }
            function d(e) {
              return 0 === q.changes.length ? void(0 !== k.length || w || ((j && M.live || A) && (r.state = "pending", r.emit("paused")), A && p())) : void((e || A || q.changes.length >= C) && (k.push(q), q = {
                seq: 0,
                changes: [],
                docs: []
            ...
            function h(e, t) {
              T || (t.message || (t.message = e), o.ok = !1, o.status = "aborting", o.errors.push(t), N = N.concat(t), k = [], q = {
                seq: 0,
                changes: [],
                docs: []
              }, p());
            ...
            function p() {
              if (!(T || r.cancelled && (o.status = "cancelled", x))) {
                ...
                if (i.length > 0) {
                  var a = N.pop();
                  N.length > 0 && (a.other_errors = N), a.result = o, Te(n, r, a, function() {
                    Be(e, t, n, r);
                  });
                } else
                  o.errors = N, r.emit("complete", o), r.removeAllListeners();
              }
            }
            function v(e) {
              if (r.cancelled)
                return p();
              var t = me(n)(e);
              t && (q.seq = e.seq, q.changes.push(e), d(M.live));
            }
            function y(e) {
              return I = !1, r.cancelled ? p() : (e.results.length > 0 ? (M.since = e.last_seq, m()) : j ? (M.live = !0, m()) : A = !0, void d(!0));
            }
            function _(e) {
              return I = !1, r.cancelled ? p() : void h("changes rejected", e);
            }
            function m() {
              function t() {
                i.cancel();
              ...
              if (!I && !A && k.length < L) {
                ...
                i.then(o, o), i.then(y)["catch"](_), n.retry && (r._changes = i, r._abortChanges = t);
              }
            }
            function g() {
              i().then(function() {
                return r.cancelled ? void p() : S.getCheckpoint().then(function(e) {
                  O = e, M = {
                    since: O,
                    limit: C,
                    batch_size: C,
                    ...
                    doc_ids: R,
                    return_docs: !0
                  }, n.filter && ("string" != typeof n.filter ? M.include_docs = !0 : M.filter = n.filter), "heartbeat" in n && (M.heartbeat = n.heartbeat), "timeout" in n && (M.timeout = n.timeout), n.query_params && (M.query_params = n.query_params), n.view && (M.view = n.view), m();
                });
              })["catch"](function(e) {
            ...
            return r.ready(e, t), r.cancelled ? void p() : (r._addedListeners || (r.once("cancel", p), "function" == typeof n.complete && (r.once("error", n.complete), r.once("complete", function(e) {
              ...
              return x = !0, S.writeCheckpoint(n.since, F);
            }).then(function() {
              return x = !1, r.cancelled ? void p() : (O = n.since, void g());
            })["catch"](b)));
          }
          function Fe() {
            $n.EventEmitter.call(this), this.cancelled = !1, this.state = "pending";
            var e = this,
                t = new ar(function(t, n) {
          ...
          function Ue(e, t, n, r) {
            if ("function" == typeof n && (r = n, n = {}), "undefined" == typeof n && (n = {}), n.doc_ids && !Array.isArray(n.doc_ids))
              throw A(wr, "`doc_ids` filter parameter is not a list.");
            n.complete = r, n = c(n), n.continuous = n.continuous || n.live, n.retry = "retry" in n ? n.retry : !1, n.PouchConstructor = n.PouchConstructor || this;
            var o = new Fe(n),
                i = Me(e, n),
                a = Me(t, n);
            return Be(i, a, n, o), o;
          ...
          function Pe(e, t, n, r) {
            return "function" == typeof n && (r = n, n = {}), "undefined" == typeof n && (n = {}), n = c(n), n.PouchConstructor = n.PouchConstructor || this, e = ao.toPouch(e, n), t = ao.toPouch(t, n), new He(e, t, n, r);
          }
          function He(e, t, n, r) {
            function o(e) {
              h.emit("change", {
            ...
            function f() {
              h.pushPaused = !1, h.pullPaused && h.emit("active", {direction: "push"});
            }
            function l() {
              h.pullPaused = !1, h.pushPaused && h.emit("active", {direction: "pull"});
            }
            function d(e) {
              return function(t, n) {
            ...
            var h = this;
            this.canceled = !1;
            var p = n.push ? Vn.extend({}, n, n.push) : n,
                v = n.pull ? Vn.extend({}, n, n.pull) : n;
            this.push = so(e, t, p), this.pull = so(t, e, v), this.pushPaused = !0, this.pullPaused = !0;
            var y = {};
            ...
            var _ = ar.all([this.push, this.pull]).then(function(e) {
              var t = {
                push: e[0],
                pull: e[1]
              };
          ...
          function Ke(e, t) {
            if ("undefined" == typeof FileReader)
              return t(Je((new FileReaderSync).readAsArrayBuffer(e)));
            var n = new FileReader,
                r = "function" == typeof n.readAsBinaryString;
            n.onloadend = function(e) {
              var n = e.target.result || "";
              return r ? t(n) : void t(Je(n));
          ...
          function Xe(e) {
            ...
            t && Object.keys(t).forEach(function(e) {
              var n = t[e];
              n.data = We(n.data, n.content_type);
            });
          }
          function ze(e) {
          ...
          function Qe(e) {
            return e._attachments && Object.keys(e._attachments) ? ar.all(Object.keys(e._attachments).map(function(t) {
              var n = e._attachments[t];
              return n.data && "string" != typeof n.data ? Ge(n.data).then(function(e) {
                n.data = e;
              }) : void 0;
            })) : ar.resolve();
          }
          ...
          function tt(e, t) {
            function n(e, t, n) {
              var r = e.ajax || {},
                  o = Vn.extend(c(p), r, t);
              return ho(o.method + " " + o.url), zr.ajax(o, n);
            }
            function r(e, t) {
              return new ar(function(r, o) {
                n(e, t, function(e, t) {
            ...
            function a() {
              ...
              return _ = r({}, t)["catch"](function(e) {
                return e && e.status && 404 === e.status ? (ge(404, "PouchDB is just detecting if the remote exists."), r({}, {
                  method: "PUT",
                  url: h
                })) : ar.reject(e);
              })["catch"](function(e) {
                return e && e.status && 412 === e.status ? !0 : ar.reject(e);
              }), _["catch"](function() {
                _ = null;
              }), _;
            }
            ...
            var u = this,
                f = $e;
            e.getHost && (f = e.getHost);
            var l = f(e.name, e),
                h = Ye(l, "");
            e = c(e);
            var p = e.ajax || {};
            if (u.getUrl = function() {
              return h;
            }, u.getHeaders = function() {
              return p.headers || {};
            }, e.auth || l.auth) {
              var v = e.auth || l.auth,
                  y = Vr(v.username + ":" + v.password);
              p.headers = p.headers || {}, p.headers.Authorization = "Basic " + y;
            }
            var _;
            setTimeout(function() {
              t(null, u);
              ...
              return "http";
            }, u.id = o("id", function(e) {
              n({}, {
                method: "GET",
                url: Ze(l, "")
              }, function(t, n) {
                var r = n && n.uuid ? n.uuid + l.db : Ye(l, "");
                e(null, r);
              });
            }), u.request = o("request", function(e, t) {
              e.url = Ye(l, e.url), n({}, e, t);
            }), u.compact = o("compact", function(e, t) {
              "function" == typeof e && (t = e, e = {}), e = c(e), n(e, {
                url: Ye(l, "_compact"),
                method: "POST"
              }, function() {
                function n() {
            ...
            }), u.bulkGet = d("bulkGet", function(e, t) {
              function r(t) {
                var r = {};
                e.revs && (r.revs = !0), e.attachments && (r.attachments = !0), n({}, {
                  url: Ye(l, "_bulk_get" + et(r)),
                  method: "POST",
                  body: {docs: e.docs}
                }, t);
              }
              function o() {
                function n(e) {
                  return function(n, r) {
                    u[e] = r.results, ++s === o && t(null, {results: Ve(u)});
                  };
                }
                for (var r = co,
                    ...
                    u = new Array(o),
                    c = 0; o > c; c++) {
                  var f = i(e, ["revs", "attachments"]);
                  f.docs = e.docs.slice(c * r, Math.min(e.docs.length, (c + 1) * r)), C(a, f, n(c));
                }
              }
              var a = this,
                  s = Ze(l, ""),
                  u = fo[s];
              "boolean" != typeof u ? r(function(e, n) {
                if (e) {
                  var r = Math.floor(e.status / 100);
                  4 === r || 5 === r ? (fo[s] = !1, ge(e.status, "PouchDB is just detecting if the remote supports the _bulk_get API."), o()) : t(e);
                } else
                  fo[s] = !0, t(null, n);
              }) : u ? r(t) : o();
            }), u._info = function(e) {
              a().then(function() {
                n({}, {
                  ...
                  return t ? e(t) : (n.host = Ye(l, ""), void e(null, n));
                });
              })["catch"](e);
            }, u.get = o("get", function(e, t, n) {
              function o(e) {
                var n = e._attachments,
                    o = n && Object.keys(n);
                return n && o.length ? ar.all(o.map(function(o) {
                  var i = n[o],
                      a = ze(e._id) + "/" + s(o) + "?rev=" + e._rev;
                  return r(t, {
                    method: "GET",
                    url: Ye(l, a),
                    binary: !0
                  }).then(function(e) {
                    return t.binary ? e : Ge(e);
                  }).then(function(e) {
              ...
              function i(e) {
                return Array.isArray(e) ? ar.all(e.map(function(e) {
                  return e.ok ? o(e.ok) : void 0;
                })) : o(e);
              }
              "function" == typeof t && (n = t, t = {}), t = c(t);
              var a = {};
              t.revs && (a.revs = !0), t.revs_info && (a.revs_info = !0), t.open_revs && ("all" !== t.open_revs && (t.open_revs = JSON.stringify(t.open_revs)), a.open_revs = t.open_revs), t.rev && (a.rev = t.rev), t.conflicts && (a.conflicts = t.conflicts), e = ze(e);
              var u = {
                method: "GET",
                url: Ye(l, e + et(a))
              };
              r(t, u).then(function(e) {
                return ar.resolve().then(function() {
                  return t.attachments ? i(e) : void 0;
                }).then(function() {
                  n(null, e);
                });
              })["catch"](n);
            }), u.remove = o("remove", function(e, t, r, o) {
              var i;
              "string" == typeof t ? (i = {
                _id: e,
                _rev: t
              ...
              n(r, {
                method: "DELETE",
                url: Ye(l, ze(i._id)) + "?rev=" + a
              }, o);
            }), u.getAttachment = o("getAttachment", function(e, t, r, o) {
            ...
            }), u.removeAttachment = o("removeAttachment", function(e, t, r, o) {
              var i = Ye(l, ze(e) + "/" + s(t)) + "?rev=" + r;
              n({}, {
                method: "DELETE",
                url: i
              }, o);
            }), u.putAttachment = o("putAttachment", function(e, t, r, o, i, a) {
              "function" == typeof i && (a = i, i = o, o = r, r = null);
              var u = ze(e) + "/" + s(t),
                  c = Ye(l, u);
              if (r && (c += "?rev=" + r), "string" == typeof o) {
                var f;
                try {
                  f = Gr(o);
                } catch (d) {
                  return a(A(_r, "Attachment is not a valid base64 string"));
                }
                o = f ? ye(f, i) : "";
              }
              var h = {
                ...
                processData: !1,
                body: o,
                timeout: p.timeout || 6e4
              };
              n({}, h, a);
            }), u._bulkDocs = function(e, t, r) {
              e.new_edits = t.new_edits, a().then(function() {
                return ar.all(e.docs.map(Qe));
              }).then(function() {
                n(t, {
                  method: "POST",
                  url: Ye(l, "_bulk_docs"),
            ...
            }, u.allDocs = o("allDocs", function(e, t) {
              "function" == typeof e && (t = e, e = {}), e = c(e);
              var n,
                  o = {},
                  i = "GET";
              ...
              if ("undefined" != typeof e.keys) {
                ...
                s.length + a.length + 1 <= lo ? a += "&" + s : (i = "POST", n = {keys: e.keys});
              }
              r(e, {
                method: i,
                url: Ye(l, "_all_docs" + a),
                body: n
              }).then(function(n) {
                e.include_docs && e.attachments && e.binary && n.rows.forEach(Xe), t(null, n);
              })["catch"](t);
            }), u._changes = function(e) {
              var t = "batch_size" in e ? e.batch_size : uo;
              e = c(e), e.timeout = "timeout" in e ? e.timeout : "timeout" in p ? p.timeout : 3e4;
              var r,
                  o = e.timeout ? {timeout: e.timeout - 5e3} : {},
                  i = "undefined" != typeof e.limit ? e.limit : !1;
              ...
              if (e.style && (o.style = e.style), (e.include_docs || e.filter && "function" == typeof e.filter) && (o.include_docs = !0), e.attachments && (o.attachments = !0), e.continuous && (o.feed = "longpoll"), e.conflicts && (o.conflicts = !0), e.descending && (o.descending = !0), "heartbeat" in e ? e.heartbeat && (o.heartbeat = e.heartbeat) : o.heartbeat = 1e4, e.filter && "string" == typeof e.filter && (o.filter = e.filter, "_view" === e.filter && e.view && "string" == typeof e.view && (o.view = e.view)), e.query_params && "object" == typeof e.query_params)
                for (var u in e.query_params)
                  e.query_params.hasOwnProperty(u) && (o[u] = e.query_params[u]);
              var f,
                  d = "GET";
              if (e.doc_ids) {
                o.filter = "_doc_ids";
                var h = JSON.stringify(e.doc_ids);
                h.length < lo ? o.doc_ids = h : (d = "POST", f = {doc_ids: e.doc_ids});
              }
              var v,
                  y,
                  _ = function(r, u) {
                    if (!e.aborted) {
                      o.since = r, "object" == typeof o.since && (o.since = JSON.stringify(o.since)), e.descending ? i && (o.limit = s) : o.limit = !i || s > t ? t : s;
                      var c = {
                        method: d,
                        url: Ye(l, "_changes" + et(o)),
                        timeout: e.timeout,
                        body: f
                      };
                      y = r, e.aborted || a().then(function() {
                        v = n(e, c, u);
                      })["catch"](u);
                    }
                  },
                  ...
                  g = function(n, o) {
                    if (!e.aborted) {
                      var a = 0;
                      if (o && o.results) {
                        a = o.results.length, m.last_seq = o.last_seq;
                        var u = {};
                        u.query = e.query_params, o.results = o.results.filter(function(t) {
                          s--;
                          var n = me(e)(t);
                          return n && (e.include_docs && e.attachments && e.binary && Xe(t), r && m.results.push(t), e.onChange(t)), n;
                        });
                      } else if (n)
                        return e.aborted = !0, void e.complete(n);
                      o && o.last_seq && (y = o.last_seq);
                      var c = i && 0 >= s || o && t > a || e.descending;
                      (!e.continuous || i && 0 >= s) && c ? e.complete(null, m) : setTimeout(function() {
                        _(y, g);
                      }, 0);
                    }
                  };
              return _(e.since || 0, g), {cancel: function() {
                  e.aborted = !0, v && v.abort();
                }};
            }, u.revsDiff = o("revsDiff", function(e, t, r) {
              ...
              n(t, {
                ...
                return t && t.status && 404 !== t.status ? r(t) : (u.emit("destroyed"), u.constructor.emit("destroyed", e.name), void r(null, n));
              });
            };
          }
          function nt() {
            this.promise = new ar(function(e) {
              e();
            });
          }
          function rt(e) {
          ...
          function ot(e) {
            ...
            return t.info().then(function(e) {
              ...
              var u = e.db_name + "-mrview-" + (i ? "temp" : rt(a));
              return h(t, "_local/mrviews", s).then(function() {
          ...
          function ct(e, t, n) {
            try {
              ...
              return ut(e, r), {error: r};
            }
          }
          function ft(e, t) {
            var n = wo(e.key, t.key);
            return 0 !== n ? n : wo(e.value, t.value);
          }
          function lt(e, t, n) {
          ...
          function ht(e) {
            e.rows.forEach(function(e) {
              ...
              t && Object.keys(t).forEach(function(e) {
                var n = t[e];
                t[e].data = We(n.data, n.content_type);
              });
            });
          }
          function pt(e) {
            return function(t) {
              return e.include_docs && e.attachments && e.binary && ht(t), t;
            };
          }
          function vt(e) {
          ...
          function gt(e) {
            return e.group_level = mt(e.group_level), e.limit = mt(e.limit), e.skip = mt(e.skip), e;
          }
          function bt(e) {
            if (e) {
              if ("number" != typeof e)
                return new Bt('Invalid value for integer: "' + e + '"');
              if (0 > e)
                return new Bt('Invalid value for positive integer: "' + e + '"');
            }
          }
          function wt(e, t) {
            var n = e.descending ? "endkey" : "startkey",
                r = e.descending ? "startkey" : "endkey";
            if ("undefined" != typeof e[n] && "undefined" != typeof e[r] && wo(e[n], e[r]) > 0)
              throw new Bt("No rows can match your key range, reverse your start_key and end_key or set {descending : true}");
            if (t.reduce && e.reduce !== !1) {
              ...
              if (e.keys && e.keys.length > 1 && !e.group && !e.group_level)
                throw new Bt("Multi-key fetches for reduce views must use {group: true}");
            }
          ...
          function Et(e, t, n) {
            var r,
                o = [],
                i = "GET";
            if (_t("reduce", n, o), _t("include_docs", n, o), _t("attachments", n, o), _t("limit", n, o), _t("descending", n, o), _t("group", n, o), _t("group_level", n, o), _t("skip", n, o), _t("stale", n, o), _t("conflicts", n, o), _t("startkey", n, o, !0), _t("start_key", n, o, !0), _t("endkey", n, o, !0), _t("end_key", n, o, !0), _t("inclusive_end", n, o), _t("key", n, o, !0), o = o.join("&"), o = "" === o ? "" : "?" + o, "undefined" != typeof n.keys) {
              var a = 2e3,
                  s = "keys=" + encodeURIComponent(JSON.stringify(n.keys));
              s.length + o.length + 1 <= a ? o += ("?" === o[0] ? "&" : "?") + s : (i = "POST", "string" == typeof t ? r = {keys: n.keys} : t.keys = n.keys);
            }
            if ("string" == typeof t) {
              var u = at(t);
              return e.request({
          ...
          function xt(e, t, n) {
            function r() {
              return st(f) ? ar.resolve(s) : t.db.get(a)["catch"](qt(s));
            }
            function o(e) {
            ...
            function i(e, t) {
              ...
              }), e.keys = Ao(f.concat(e.keys)), n.push(e), n;
            }
            var a = "_local/doc_" + e,
                s = {
                  _id: a,
          ...
          function At(e, t, n) {
            ...
            return e.db.get(r)["catch"](qt({
              _id: r,
              seq: 0
            })).then(function(r) {
              var o = Object.keys(t);
              return ar.all(o.map(function(n) {
                return xt(n, e, t);
              })).then(function(t) {
                var o = Ve(t);
          ...
          function Tt(e) {
            var t = "string" == typeof e ? e : e.name,
                n = jo[t];
            return n || (n = jo[t] = new nt), n;
          }
          function Ot(e) {
            return xo(Tt(e), function() {
              return jt(e);
            })();
          }
          function jt(e) {
            function t(e, t) {
              ...
              "undefined" != typeof t && null !== t && (n.value = So(t)), r.push(n);
            }
            function n(t, n) {
              return function() {
                return At(e, t, n);
            ...
            if ("function" == typeof e.mapFun && 2 === e.mapFun.length) {
              ...
              i = it(e.mapFun.toString(), t, yt, po, Array.isArray, JSON.parse);
            var s = e.seq || 0,
                u = new nt;
            return new ar(function(t, a) {
              function c() {
              ...
              function f() {
                ...
                e.sourceDB.changes({
                  ...
                  for (var l = {},
                    ...
                    var p = a[d];
                    if ("_" !== p.doc._id[0]) {
                      r = [], o = p.doc, o._deleted || ct(e.sourceDB, i, [o]), r.sort(ft);
                      for (var v,
                          y = {},
                          _ = 0,
                          m = r.length; m > _; _++) {
                  ...
                  return u.add(n(l, s)), a.length < Lo ? c() : f();
                }).on("error", t);
              }
              f();
            });
          ...
          function Ct(e, t, n) {
            ...
            r = Io[e.reduceFun] ? Io[e.reduceFun] : it(e.reduceFun.toString(), null, yt, po, Array.isArray, JSON.parse);
            var i = [],
                a = n.group_level;
            t.forEach(function(e) {
              var t = i[i.length - 1],
                  n = o ? e.key : null;
              return o && Array.isArray(n) && "number" == typeof a && (n = n.length > a ? n.slice(0, a) : n), t && 0 === wo(t.key[0][0], n) ? (t.key.push([n, e.id]), void t.value.push(e.value)) : void i.push({
                key: [[n, e.id]],
                value: [e.value]
              });
            });
            for (var s = 0,
                u = i.length; u > s; s++) {
              var c = i[s],
                  f = ct(e.sourceDB, r, [c.key, c.value, !1]);
              if (f.error && f.error instanceof Mt)
                throw f.error;
              c.value = f.error ? null : f.output, c.key = c.key[0][0];
            }
            return {rows: lt(i, n.limit, n.skip)};
          }
          function Lt(e, t) {
            return xo(Tt(e), function() {
              return It(e, t);
          ...
          function It(e, t) {
            ...
            if ("undefined" == typeof t.keys || t.keys.length || (t.limit = 0, delete t.keys), "undefined" != typeof t.keys) {
              ...
              return ar.all(u).then(Ve).then(r);
            }
            var c = {descending: t.descending};
            if (t.start_key && (t.startkey = t.start_key), t.end_key && (t.endkey = t.end_key), "undefined" != typeof t.startkey && (c.startkey = Eo(t.descending ? [t.startkey, {}] : [t.startkey])), "undefined" != typeof t.endkey) {
              var f = t.inclusive_end !== !1;
              t.descending && (f = !f), c.endkey = Eo(f ? [t.endkey, {}] : [t.endkey]);
            }
              ...
              return e.allDocs(r).then(function(r) {
                ...
                var i = Object.keys(o).filter(function(e) {
                  return !o[e];
                    ...
                    a = i.map(function(t) {
                      return xo(Tt(t), function() {
                        return new e.constructor(t, e.__opts).destroy();
                      })();
                    });
                return ar.all(a).then(function() {
                  return {ok: !0};
                });
              });
            }, qt({ok: !0}));
          ...
          function Nt(e, t, r) {
            ...
            if ("string" != typeof t) {
              ...
              return Co.add(function() {
                return ot(o).then(function(e) {
                  function t() {
                    return e.db.destroy();
                  }
                  return To(Ot(e).then(function() {
                    return Lt(e, r);
                  }), t);
                });
              }), Co.finish();
            ...
            return e.get("_design/" + s).then(function(t) {
              ...
              if (!o || "string" != typeof o.map)
                throw new Ft("ddoc " + s + " has no view named " + u);
              wt(r, o);
              var a = {
                db: e,
                viewName: i,
          ...
          function Ut(e, t, n) {
            function r(e) {
              try {
                ...
                var n = A(_r, "Attachment is not a valid base64 string");
                return {error: n};
              }
            }
            function o(e, n) {
              ...
              if ("string" == typeof e.data) {
                ...
                if (o.error)
                  return n(o.error);
                e.length = o.length, "blob" === t ? e.data = ye(o, e.content_type) : "base64" === t ? e.data = Vr(o) : e.data = o, io(o).then(function(t) {
                  e.digest = "md5-" + t, n();
                });
              } else
                ie(e.data, function(r) {
                  "binary" === t ? e.data = Je(r) : "base64" === t && (e.data = Vr(Je(r))), io(r).then(function(t) {
                    e.digest = "md5-" + t, e.length = r.byteLength, n();
                  });
                });
            }
            function i() {
              s++, e.length === s && (a ? n(a) : n());
            }
            if (!e.length)
              return n();
            var a,
            ...
            e.forEach(function(e) {
              ...
              for (var s in e.data._attachments)
                e.data._attachments.hasOwnProperty(s) && o(e.data._attachments[s], t);
            });
          }
          function Pt(e, t) {
            return e.pos - t.pos;
            ...
            for (var n = [{
              ...
              for (var s = 0; s < a[2].length; s++)
                if (i[2][0]) {
                  ...
                  u || (r = "new_branch", Wt(i[2], a[2][s], Kt));
                } else
          ...
          function Vt(e, t, n) {
            ...
            for (var s = 0,
              ...
              if (c.pos === t.pos && c.ids[0] === t.ids[0])
                ...
                var g = h[0];
                g ? (r = Gt(g.ids, l.ids), g.parent[2][g.parentIdx] = r.tree, o.push({
                  pos: f.pos,
                  ids: f.ids
          ...
          function $t(e, t, n, r, o, i, a, s) {
            if (Qt(t.rev_tree, n.metadata.rev))
              return r[o] = n, i();
            var u = t.winningRev || v(t),
                c = "deleted" in t ? t.deleted : _(t, u),
                f = "deleted" in n.metadata ? n.metadata.deleted : _(n.metadata),
                l = /^1-/.test(n.metadata.rev);
            if (c && !f && s && l) {
              var d = n.data;
              d._rev = u, d._id = n.metadata.id, n = U(d, s);
            }
            var h = zt(t.rev_tree, n.metadata.rev_tree[0], e),
                p = s && (c && f || !c && "new_leaf" !== h.conflicts || c && !f && "new_branch" === h.conflicts);
            if (p) {
              var y = A(lr);
              return r[o] = y, i();
            }
            var m = n.metadata.rev;
            n.metadata.rev_tree = h.tree, t.rev_map && (n.metadata.rev_map = t.rev_map);
            var g,
                b = v(n.metadata),
                w = _(n.metadata, b),
                E = c === w ? 0 : w > c ? -1 : 1;
            g = m === b ? w : _(n.metadata, m), a(n, b, w, g, !0, E, o, i);
          }
          function Yt(e) {
            return "missing" === e.metadata.rev_tree[0].ids[1].status;
          }
          function Zt(e, t, n, r, o, i, a, s, u) {
            function c(e, t, n) {
              var r = v(e.metadata),
                  o = _(e.metadata, r);
              if ("was_delete" in s && o)
                return i[t] = A(fr, "deleted"), n();
              var u = l && Yt(e);
              if (u) {
                var c = A(lr);
                return i[t] = c, n();
            ...
            t.forEach(function(e, t) {
              ...
              function s() {
                var s = t[u],
                    ...
                    d = s[1];
                if (r.has(n))
                  $t(e, r.get(n), f, i, d, o, a, l);
                else {
                  var h = zt([], f.metadata.rev_tree[0], e);
          ...
          function en(e) {
            var t = [];
            return E(e.rev_tree, function(e, n, r, o, i) {
          ...
          function on(e) {
            if (!Ko.running && Ko.queue.length) {
              Ko.running = !0;
              var t = Ko.queue.shift();
              t.action(function(r, o) {
                rn(t.callback, this, [r, o], e), Ko.running = !1, n.nextTick(function() {
                  on(e);
                });
              });
            }
          ...
          function an(e) {
            return function(t) {
              var n = "unknown_error";
              t.target && t.target.error && (n = t.target.error.name || t.target.error.message), e(A(kr, n, t.type));
            };
          }
          function sn(e, t, n) {
            return {
          ...
          function fn(e, t, n, r) {
            n ? r(e ? "string" != typeof e ? e : We(e, t) : oe([""], {type: t})) : e ? "string" != typeof e ? Ke(e, function(e) {
              r(Vr(e));
            }) : r(e) : r("");
          }
          function ln(e, t, n, r) {
          ...
          function dn(e, t) {
            return ar.all(e.map(function(e) {
              if (e.doc && e.doc._attachments) {
                var n = Object.keys(e.doc._attachments);
                return ar.all(n.map(function(n) {
                  var r = e.doc._attachments[n];
                  if ("body" in r) {
                    var o = r.body,
                        a = r.content_type;
                    return new ar(function(s) {
                      fn(o, a, t, function(t) {
                        e.doc._attachments[n] = Vn.extend(i(r, ["digest", "content_type"]), {data: t}), s();
                      });
                    });
                  }
                }));
          ...
          function vn(e, t, n, r, o, i, a) {
            function s() {
              var e = [Fo, Mo, Uo, Ho, Wo, Po],
                  t = pn(o, e, "readwrite");
              return t.error ? a(t.error) : (g = t.txn, g.onabort = an(a), g.ontimeout = an(a), g.oncomplete = f, b = g.objectStore(Fo), w = g.objectStore(Mo), E = g.objectStore(Uo), S = g.objectStore(Po), void d(function(e) {
                return e ? (R = !0, a(e)) : void c();
              }));
            }
            function u() {
              Zt(e.revs_limit, q, r, I, g, C, h, n);
            }
            function c() {
              function e() {
                ++n === q.length && u();
            ...
            function f() {
              R || (i.notify(r._meta.name), r._meta.docCount += x, a(null, C));
            }
            function l(e, t) {
              var n = E.get(e);
              n.onsuccess = function(n) {
                if (n.target.result)
                  ...
                  var r = A(jr, "unknown stub attachment with digest " + e);
                  r.status = 412, t(r);
                }
              };
            }
            ...
            function h(e, t, n, r, o, i, a, s) {
              x += i, e.metadata.winningRev = t, e.metadata.deleted = n;
              var u = e.data;
              u._id = e.metadata.id, u._rev = e.metadata.rev, r && (u._deleted = !0);
              var c = u._attachments && Object.keys(u._attachments).length;
              return c ? y(e, t, n, o, a, s) : void v(e, t, n, o, a, s);
            }
            function p(e) {
              var t = en(e.metadata);
              hn(t, e.metadata.id, g);
            }
            function v(e, t, n, o, i, a) {
              function s(i) {
                o && r.auto_compaction && p(e), l.seq = i.target.result, delete l.rev;
                var a = sn(l, t, n),
                    s = b.put(a);
                s.onsuccess = c;
              }
              ...
              function c() {
                C[i] = {
                  ...
                  id: l.id,
                  rev: t
                }, I.set(e.metadata.id, e.metadata), _(e, l.seq, a);
              }
              var f = e.data,
                  l = e.metadata;
            ...
            for (var g,
                ...
                O = q.length; O > T; T++) {
              var j = q[T];
              j._id && L(j._id) || (j = q[T] = U(j, n.new_edits), j.error && !k && (k = j));
            }
            if (k)
              return a(k);
            var C = new Array(q.length),
                I = new Qn.Map,
                R = !1,
                D = r._meta.blobSupport ? "blob" : "base64";
            Ut(q, D, function(e) {
              return e ? a(e) : void s();
            });
          }
            ...
            function o(e, r) {
              function o(t, n, r) {
                ...
                S.get(o).onsuccess = function(r) {
                  n.doc = cn(r.target.result), e.conflicts && (n.doc._conflicts = q(t)), ln(n.doc, e, g);
                };
              }
              function i(t, n, r) {
                var i = {
              ...
              function u() {
                e.attachments ? dn(k, e.binary).then(s) : s();
              }
              var c = "startkey" in e ? e.startkey : !1,
                  ...
                  y = yn(c, f, p, l, v);
              if (y && y.error)
                return _n(t, e, y.error, r);
              var _ = [Fo, Mo];
              e.attachments && _.push(Uo);
              var m = pn(n, _, "readonly");
              if (m.error)
                return r(m.error);
              var g = m.txn,
                  b = g.objectStore(Fo),
          ...
          function gn(e) {
            return new ar(function(t) {
              var n = oe([""]);
              e.objectStore(Jo).put(n, "key"), e.onabort = function(e) {
          ...
          function bn(e) {
            te() ? chrome.storage.onChanged.addListener(function(t) {
              null != t.db_name && e.emit(t.dbName.newValue);
            }) : ne() && ("undefined" != typeof addEventListener ? addEventListener("storage", function(t) {
              e.emit(t.key);
          ...
          function wn() {
            $n.EventEmitter.call(this), this._listeners = {}, bn(this);
          }
          function En(e, t) {
            var n = this;
            Ko.queue.push({
          ...
          function Sn(e, t, r) {
            function o(e) {
              var t = e.createObjectStore(Fo, {keyPath: "id"});
              e.createObjectStore(Mo, {autoIncrement: !0}).createIndex("_doc_id_rev", "_doc_id_rev", {unique: !0}), e.createObjectStore(Uo, {keyPath: "digest"}), e.createObjectStore(Ho, {
                keyPath: "id",
                autoIncrement: !1
              }), e.createObjectStore(Jo), t.createIndex("deletedOrLocal", "deletedOrLocal", {unique: !1}), e.createObjectStore(Wo, {keyPath: "_id"});
              var n = e.createObjectStore(Po, {autoIncrement: !0});
              n.createIndex("seq", "seq"), n.createIndex("digestSeq", "digestSeq", {unique: !0});
            }
            function i(e, t) {
              var n = e.objectStore(Fo);
            ...
            function a(e) {
              e.createObjectStore(Wo, {keyPath: "_id"}).createIndex("_doc_id_rev", "_doc_id_rev", {unique: !0});
            }
            function s(e, t) {
              var n = e.objectStore(Wo),
                  r = e.objectStore(Fo),
                  o = e.objectStore(Mo),
                  i = r.openCursor();
                ...
                if (i) {
                  ...
                  if (u) {
                    ...
                    y.onsuccess = function(e) {
                      if (y = e.target.result) {
                        var t = y.value;
                        t._doc_id_rev === f && n.put(t), o["delete"](y.primaryKey), y["continue"]();
                      } else
            ...
            function u(e) {
              var t = e.createObjectStore(Po, {autoIncrement: !0});
              t.createIndex("seq", "seq"), t.createIndex("digestSeq", "digestSeq", {unique: !0});
            }
            function f(e, t) {
              var n = e.objectStore(Mo),
                  r = e.objectStore(Uo),
                  o = e.objectStore(Po),
                  i = r.count();
              i.onsuccess = function(e) {
            ...
            function d(e) {
              function t(e) {
                return e.data ? un(e) : (e.deleted = "1" === e.deletedOrLocal, e);
              }
              var n = e.objectStore(Mo),
                  r = e.objectStore(Fo),
                  o = r.openCursor();
              o.onsuccess = function(e) {
                ...
                function i() {
                  var e = sn(s, s.winningRev, s.deleted),
                      t = r.put(e);
                ...
                if (a) {
                  var s = t(a.value);
                  return s.winningRev = s.winningRev || v(s), s.seq ? i() : void o();
                }
              };
            }
            var h = t.name,
            ...
            e._meta = null, e.type = function() {
              ...
              var o,
                  ...
                  s = t.ctx;
              if (!s) {
                var u = pn(p, [Fo, Mo, Uo], "readonly");
                if (u.error)
                  return n(u.error);
                s = u.txn;
              }
              s.objectStore(Fo).get(e).onsuccess = function(e) {
                if (i = un(e.target.result), !i)
                  return a = A(fr, "missing"), r();
                if (_(i) && !t.rev)
                  return a = A(fr, "deleted"), r();
                var n = s.objectStore(Mo),
                    u = t.rev || i.winningRev,
                    c = i.id + "::" + u;
                n.index("_doc_id_rev").get(c).onsuccess = function(e) {
                  return o = e.target.result, o && (o = cn(o)), o ? void r() : (a = A(fr, "missing"), r());
                };
              };
              ...
              var i = e.digest,
                  a = e.content_type;
              r.objectStore(Uo).get(i).onsuccess = function(e) {
                var r = e.target.result.body;
                fn(r, a, t.binary, function(e) {
                  n(null, e);
                });
              };
            }, e._info = function(t) {
              ...
              if (i.error)
                return t(i.error);
              var a = i.txn,
                  s = a.objectStore(Mo).openCursor(null, "prev");
              ...
              function n(e) {
                function n() {
                  return c.seq !== a ? e["continue"]() : (u = a, c.winningRev === i._rev ? o(i) : void r());
                }
                function r() {
                  var e = i._id + "::" + c.winningRev,
                      t = _.get(e);
                ...
                function o(n) {
                  var r = t.processChange(n, c, t);
                  r.seq = c.seq;
                  var o = b(r);
                  return "object" == typeof o ? t.complete(o) : (o && (g++, l && m.push(r), t.attachments && t.include_docs ? ln(n, t, d, function() {
                    dn([r], t.binary).then(function() {
                      t.onChange(r);
                    });
                  }) : t.onChange(r)), void(g !== f && e["continue"]()));
                }
                var i = cn(e.value),
                    a = e.key;
                if (s && !s.has(i._id))
                  return e["continue"]();
                var c;
                return (c = w.get(i._id)) ? n() : void(y.get(i._id).onsuccess = function(e) {
                  c = un(e.target.result), w.set(i._id, c), n();
                });
              }
              function r(e) {
                var t = e.target.result;
              ...
              function o() {
                var e = [Fo, Mo];
                t.attachments && e.push(Uo);
                var n = pn(p, e, "readonly");
                if (n.error)
                  return t.complete(n.error);
                d = n.txn, d.onabort = an(t.complete), d.oncomplete = i, v = d.objectStore(Mo), y = d.objectStore(Fo), _ = v.index("_doc_id_rev");
                var o;
                o = t.descending ? v.openCursor(null, "prev") : v.openCursor(IDBKeyRange.lowerBound(t.since, !0)), o.onsuccess = r;
              }
              function i() {
                function e() {
                  t.complete(null, {
                ...
                !t.continuous && t.attachments ? dn(m).then(e) : e();
              }
              if (t = c(t), t.continuous) {
                var a = h + ":" + D();
                return En.Changes.addListener(h, a, e, t), En.Changes.notify(h), {cancel: function() {
                    En.Changes.removeListener(h, a);
                  }};
              }
              var s = t.doc_ids && new Qn.Set(t.doc_ids);
              t.since = t.since || 0;
              var u = t.since,
                  f = "limit" in t ? t.limit : -1;
              0 === f && (f = 1);
              var l;
              l = "return_docs" in t ? t.return_docs : "returnDocs" in t ? t.returnDocs : !0;
              var d,
                  v,
                  y,
                  _,
              ...
              return null === p ? e(A(vr)) : (p.close(), delete Vo[h], p = null, void e());
            }, e._getRevisionTree = function(e, t) {
              var n = pn(p, [Fo], "readonly");
              if (n.error)
                return t(n.error);
              var r = n.txn,
                  o = r.objectStore(Fo).get(e);
              o.onsuccess = function(e) {
                var n = un(e.target.result);
                n ? t(null, n.rev_tree) : t(A(fr));
              };
              ...
              a.get(e).onsuccess = function(n) {
                ...
                var o = r.winningRev,
                    a = r.deleted;
                i.objectStore(Fo).put(sn(r, o, a));
              }, i.onabort = an(n), i.oncomplete = function() {
                n();
              };
            }, e._getLocal = function(e, t) {
              var n = pn(p, [Wo], "readonly");
              if (n.error)
                return t(n.error);
              var r = n.txn,
                  o = r.objectStore(Wo).get(e);
              o.onerror = an(t), o.onsuccess = function(e) {
                var n = e.target.result;
                n ? (delete n._doc_id_rev, t(null, n)) : t(A(fr));
              };
              ...
              var i,
                  a = t.ctx;
              if (!a) {
                var s = pn(p, [Wo], "readwrite");
                if (s.error)
                  return n(s.error);
                a = s.txn, a.onerror = an(n), a.oncomplete = function() {
                  i && n(null, i);
                };
              }
              var u,
              ...
              r ? (u = c.get(o), u.onsuccess = function(o) {
                ...
                n(A(lr)), e.preventDefault(), e.stopPropagation();
              ...
              var i,
                  ...
                  s = r.objectStore(Wo),
                  u = s.get(a);
              u.onerror = an(n), u.onsuccess = function(r) {
                var o = r.target.result;
                o && o._rev === e._rev ? (s["delete"](a), i = {
                  ok: !0,
                  id: a,
                  rev: "0-0"
                }, t.ctx && n(null, i)) : n(A(fr));
              };
            }, e._destroy = function(e, t) {
              En.Changes.removeAllListeners(h), En.openReqList[h] && En.openReqList[h].result && (En.openReqList[h].result.close(), delete Vo[h]);
              var n = indexedDB.deleteDatabase(h);
              n.onsuccess = function() {
                En.openReqList[h] && (En.openReqList[h] = null), ne() && h in localStorage && delete localStorage[h], t(null, {ok: !0});
              }, n.onerror = an(t);
            };
            var y = Vo[h];
            if (y)
              return p = y.idb, e._meta = y.global, void n.nextTick(function() {
                r(null, e);
              });
            var m;
            m = t.storage ? kn(h, t.storage) : indexedDB.open(h, Bo), "openReqList" in En || (En.openReqList = {}), En.openReqList[h] = m, m.onupgradeneeded = function(e) {
              function t() {
                var e = c[l - 1];
                l++, e && e(r, t);
              }
              ...
              p = t.target.result, p.onversionchange = function() {
                p.close(), delete Vo[h];
              }, p.onabort = function(e) {
                console.error("Database has a global failure", e.target.error), p.close(), delete Vo[h];
              };
              var n = p.transaction([Ho, Jo, Fo], "readwrite"),
                  o = n.objectStore(Ho).get(Ho),
                  i = null,
                  a = null,
                  s = null;
              o.onsuccess = function(t) {
                var o = function() {
                  null !== i && null !== a && null !== s && (e._meta = {
                    ...
                    u = t.target.result || {id: Ho};
                h + "_id" in u ? (s = u[h + "_id"], o()) : (s = D(), u[h + "_id"] = s, n.objectStore(Ho).put(u).onsuccess = function() {
                  o();
                }), Go || (Go = gn(n)), Go.then(function(e) {
                  i = e, o();
                });
                var c = n.objectStore(Fo).index("deletedOrLocal");
          ...
          function An(e, t, n) {
            for (var r = ""; n > t; )
              r += String.fromCharCode(xn(e.charCodeAt(t++)) << 4 | xn(e.charCodeAt(t++)));
            return r;
          }
          function Tn(e, t, n) {
            for (var r = ""; n > t; )
              r += String.fromCharCode(xn(e.charCodeAt(t + 2)) << 12 | xn(e.charCodeAt(t + 3)) << 8 | xn(e.charCodeAt(t)) << 4 | xn(e.charCodeAt(t + 1))), t += 4;
            return r;
          }
          function On(e, t) {
            return "UTF-8" === t ? qn(An(e, 0, e.length)) : Tn(e, 0, e.length);
          }
          function jn(e) {
            return "'" + e + "'";
          }
          ...
          function Bn(e, t, n) {
            ...
            function o() {
              if (a.length) {
                var e = "SELECT DISTINCT digest AS digest FROM " + ei + " WHERE seq IN " + Dn(a.length);
                n.executeSql(e, a, function(e, t) {
                  for (var n = [],
                      r = 0; r < t.rows.length; r++)
                    n.push(t.rows.item(r).digest);
                  if (n.length) {
                    var o = "DELETE FROM " + ei + " WHERE seq IN (" + a.map(function() {
                      return "?";
                    }).join(",") + ")";
                    e.executeSql(o, a, function(e) {
                      var t = "SELECT digest FROM " + ei + " WHERE digest IN (" + n.map(function() {
                        return "?";
                      }).join(",") + ")";
                      e.executeSql(t, n, function(e, t) {
                        for (var r = new Qn.Set,
                            o = 0; o < t.rows.length; o++)
                          r.add(t.rows.item(o).digest);
                        n.forEach(function(t) {
                          r.has(t) || (e.executeSql("DELETE FROM " + ei + " WHERE digest=?", [t]), e.executeSql("DELETE FROM " + $o + " WHERE digest=?", [t]));
                        });
                      });
                    });
                  }
            ...
            if (e.length) {
              var i = 0,
                  a = [];
              e.forEach(function(e) {
                var o = "SELECT seq FROM " + Qo + " WHERE doc_id=? AND rev=?";
                n.executeSql(o, [t, e], function(e, t) {
                  if (!t.rows.length)
                    return r();
                  var n = t.rows.item(0).seq;
                  a.push(n), e.executeSql("DELETE FROM " + Qo + " WHERE seq=?", [n], r);
                });
              });
            }
          }
          ...
          function Hn(e) {
            ...
            if (!t) {
              var n = Un();
              t = ti[e.name] = Pn(n, e), t.db && (t.db._sqlitePlugin = "undefined" != typeof sqlitePlugin);
            }
            return t;
          }
          function Wn() {
          ...
          function Jn(e, t, n, r, o, i, a) {
            function s() {
              return g ? a(g) : (i.notify(r._name), r._docCount = -1, void a(null, b));
            }
            function u(e, t) {
              var n = "SELECT count(*) as cnt FROM " + $o + " WHERE digest=?";
              m.executeSql(n, [e], function(n, r) {
                if (0 === r.rows.item(0).cnt) {
                  var o = A(jr, "unknown stub attachment with digest " + e);
                  t(o);
                } else
                  t();
              });
            ...
            function f(e, t, n, o, i, a, s, u) {
              function c() {
                function t(e, t) {
                  ...
                  function o(t) {
                    var o = "INSERT INTO " + ei + " (digest, seq) VALUES (?,?)",
                ...
                var n = e.data,
                    ...
                    a = n._rev,
                    s = In(n),
                    u = "INSERT INTO " + Qo + " (doc_id, rev, json, deleted) VALUES (?, ?, ?, ?);",
                    c = [i, a, s, r];
                m.executeSql(u, c, function(e, n) {
                  ...
                  var e = Nn("seq", Qo, null, "doc_id=? AND rev=?");
                  return m.executeSql(e, [i, a], function(e, n) {
                    var o = n.rows.item(0).seq,
                        u = "UPDATE " + Qo + " SET json=?, deleted=? WHERE doc_id=? AND rev=?;",
                        c = [s, r, i, a];
              ...
              function p(n, r) {
                ...
                var o = i ? "UPDATE " + zo + " SET json=?, max_seq=?, winningseq=(SELECT seq FROM " + Qo + " WHERE doc_id=" + zo + ".id AND rev=?) WHERE id=?" : "INSERT INTO " + zo + " (id, winningseq, max_seq, json) VALUES (?,?,?,?);",
                    a = nn(e.metadata),
                    c = e.metadata.id,
                    f = i ? [a, r, t, c] : [c, r, r, a];
            ...
            function d(e) {
              ...
              y.forEach(function(e) {
                if (e._id && L(e._id))
                  return t();
                var n = e.metadata.id;
                m.executeSql("SELECT json FROM " + zo + " WHERE id = ?", [n], function(e, r) {
                  if (r.rows.length) {
                    var o = tn(r.rows.item(0).json);
                    w.set(n, o);
                  }
                  t();
                });
            ...
            function h(e, t, n) {
              var r = "SELECT digest FROM " + $o + " WHERE digest=?";
              m.executeSql(r, [e], function(o, i) {
                return i.rows.length ? n() : (r = "INSERT INTO " + $o + " (digest, body, escaped) VALUES (?,?,1)", void o.executeSql(r, [e, Cn(t)], function() {
                  n();
                }, function() {
                  return n(), !1;
                }));
            ...
            var m,
                g,
                b = new Array(y.length),
                w = new Qn.Map;
            Ut(y, "binary", function(e) {
          ...
          function Kn(e, t, n, r, o) {
            ...
            function s(e, o) {
              var s = e._attachments[o],
                  u = {
                    binary: t.binary,
                    ctx: r
                  };
              n._getAttachment(s, u, function(t, n) {
                e._attachments[o] = Vn.extend(i(s, ["digest", "content_type"]), {data: n}), a();
              });
            }
            ...
            u.forEach(function(n) {
              t.attachments && t.include_docs ? s(e, n) : (e._attachments[n].stub = !0, a());
            });
          }
          function Gn(e, t) {
            function n() {
              ne() && (window.localStorage["_pouch__websqldb_" + g._name] = !0), t(null, g);
            }
            function r(e, t) {
              e.executeSql(ii), e.executeSql("ALTER TABLE " + Qo + " ADD COLUMN deleted TINYINT(1) DEFAULT 0", [], function() {
                e.executeSql(ri), e.executeSql("ALTER TABLE " + zo + " ADD COLUMN local TINYINT(1) DEFAULT 0", [], function() {
                  e.executeSql("CREATE INDEX IF NOT EXISTS 'doc-store-local-idx' ON " + zo + " (local, id)");
                  var n = "SELECT " + zo + ".winningseq AS seq, " + zo + ".json AS metadata FROM " + Qo + " JOIN " + zo + " ON " + Qo + ".seq = " + zo + ".winningseq";
                  e.executeSql(n, [], function(e, n) {
                    for (var r = [],
                      ...
                      _(u) && r.push(s), L(u.id) && o.push(u.id);
                    }
                    e.executeSql("UPDATE " + zo + "SET local = 1 WHERE id IN " + Dn(o.length), o, function() {
                      e.executeSql("UPDATE " + Qo + " SET deleted = 1 WHERE seq IN " + Dn(r.length), r, t);
                    });
                  });
                });
              });
            ...
            function o(e, t) {
              var n = "CREATE TABLE IF NOT EXISTS " + Yo + " (id UNIQUE, rev, json)";
              e.executeSql(n, [], function() {
                var n = "SELECT " + zo + ".id AS id, " + Qo + ".json AS data FROM " + Qo + " JOIN " + zo + " ON " + Qo + ".seq = " + zo + ".winningseq WHERE local = 1";
                e.executeSql(n, [], function(e, n) {
                  function r() {
                    if (!o.length)
                      return t(e);
                    ...
                    e.executeSql("INSERT INTO " + Yo + " (id, rev, json) VALUES (?,?,?)", [n.id, i, n.data], function(e) {
                      e.executeSql("DELETE FROM " + zo + " WHERE id=?", [n.id], function(e) {
                        e.executeSql("DELETE FROM " + Qo + " WHERE seq=?", [n.seq], function() {
                          r();
                        });
                      });
                    });
            ...
            function i(e, t) {
              function n(n) {
                function r() {
                  ...
                  var o = n.shift(),
                      ...
                      s = i.substring(0, a),
                      u = i.substring(a + 2),
                      c = "UPDATE " + Qo + " SET doc_id=?, rev=? WHERE doc_id_rev=?";
              ...
              var r = "ALTER TABLE " + Qo + " ADD COLUMN doc_id";
              e.executeSql(r, [], function(e) {
                var t = "ALTER TABLE " + Qo + " ADD COLUMN rev";
                e.executeSql(t, [], function(e) {
                  e.executeSql(oi, [], function(e) {
                    var t = "SELECT hex(doc_id_rev) as hex FROM " + Qo;
            ...
            function a(e, t) {
              function n(e) {
                var n = "SELECT COUNT(*) AS cnt FROM " + $o;
                e.executeSql(n, [], function(e, n) {
                  function r() {
                    var n = Nn(ci + ", " + zo + ".id AS id", [zo, Qo], ui, null, zo + ".id ");
                    n += " LIMIT " + a + " OFFSET " + i, i += a, e.executeSql(n, [], function(e, n) {
                      ...
                      if (!n.rows.length)
                        return t(e);
                      for (var i = {},
                          a = 0; a < n.rows.length; a++)
                        for (var s = n.rows.item(a),
                            u = Rn(s.data, s.id, s.rev),
                      ...
                      d.forEach(function(t) {
                        var n = "INSERT INTO " + ei + " (digest, seq) VALUES (?,?)";
              ...
              var r = "CREATE TABLE IF NOT EXISTS " + ei + " (digest, seq INTEGER)";
              e.executeSql(r, [], function(e) {
                e.executeSql(si, [], function(e) {
                  e.executeSql(ai, [], n);
                });
              });
            }
            function s(e, t) {
              var n = "ALTER TABLE " + $o + " ADD COLUMN escaped TINYINT(1) DEFAULT 0";
              e.executeSql(n, [], t);
            }
            function u(e, t) {
              var n = "ALTER TABLE " + zo + " ADD COLUMN max_seq INTEGER";
              e.executeSql(n, [], function(e) {
                var n = "UPDATE " + zo + " SET max_seq=(SELECT MAX(seq) FROM " + Qo + " WHERE doc_id=id)";
                e.executeSql(n, [], function(e) {
                  var n = "CREATE UNIQUE INDEX IF NOT EXISTS 'doc-max-seq-idx' ON " + zo + " (max_seq)";
                  e.executeSql(n, [], t);
                });
              });
            }
            ...
            function h(e, t) {
              if (0 === t) {
                var n = "CREATE TABLE IF NOT EXISTS " + Zo + " (dbid, db_version INTEGER)",
                    c = "CREATE TABLE IF NOT EXISTS " + $o + " (digest UNIQUE, escaped TINYINT(1), body BLOB)",
                    f = "CREATE TABLE IF NOT EXISTS " + ei + " (digest, seq INTEGER)",
                    l = "CREATE TABLE IF NOT EXISTS " + zo + " (id unique, json, winningseq, max_seq INTEGER UNIQUE)",
                    h = "CREATE TABLE IF NOT EXISTS " + Qo + " (seq INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, json, deleted TINYINT(1), doc_id, rev)",
                    p = "CREATE TABLE IF NOT EXISTS " + Yo + " (id UNIQUE, rev, json)";
                e.executeSql(c), e.executeSql(p), e.executeSql(f, [], function() {
                  e.executeSql(ai), e.executeSql(si);
                }), e.executeSql(l, [], function() {
                  e.executeSql(ii), e.executeSql(h, [], function() {
                    e.executeSql(ri), e.executeSql(oi), e.executeSql(n, [], function() {
                      var t = "INSERT INTO " + Zo + " (db_version, dbid) VALUES (?,?)";
                      b = D();
                      var n = [Xo, b];
                ...
                var v = function() {
                  var n = Xo > t;
                  n && e.executeSql("UPDATE " + Zo + " SET db_version = " + Xo);
                  var r = "SELECT dbid FROM " + Zo;
            ...
            function v(e) {
              var t = "SELECT sql FROM sqlite_master WHERE tbl_name = " + Zo;
              e.executeSql(t, [], function(e, t) {
                t.rows.length ? /db_version/.test(t.rows.item(0).sql) ? e.executeSql("SELECT db_version FROM " + Zo, [], function(e, t) {
                  var n = t.rows.item(0).db_version;
                  h(e, n);
                }) : e.executeSql("ALTER TABLE " + Zo + " ADD COLUMN db_version INTEGER", [], function() {
                  h(e, 1);
                }) : h(e, 0);
              });
            }
            function y(e, t) {
              if (-1 !== g._docCount)
                return t(g._docCount);
              var n = Nn("COUNT(" + zo + ".id) AS 'num'", [zo, Qo], ui, Qo + ".deleted=0");
              e.executeSql(n, [], function(e, n) {
                g._docCount = n.rows.item(0).num, t(g._docCount);
              });
            }
            var m,
                g = this,
            ...
            if (k.error)
              return Fn(t)(k.error);
            var x = k.db;
            "function" != typeof x.readTransaction && (x.readTransaction = x.transaction), p(), g.type = function() {
              return "websql";
            }, g._id = l(function(e) {
              e(null, b);
            }), g._info = function(e) {
              x.readTransaction(function(t) {
                y(t, function(n) {
                  var r = "SELECT MAX(seq) AS seq FROM " + Qo;
                  t.executeSql(r, [], function(t, r) {
                    var o = r.rows.item(0).seq || 0;
                    e(null, {
                      doc_count: n,
                      update_seq: o,
                      sqlite_plugin: x._sqlitePlugin,
                      websql_encoding: m
                    });
                  });
                });
              }, Fn(e));
            }, g._bulkDocs = function(t, n, r) {
              Jn(e, t, n, g, x, Gn.Changes, r);
            }, g._get = function(e, t, n) {
              function r() {
                n(a, {
                  doc: o,
                  metadata: i,
              ...
              var o,
                  ...
                  s = t.ctx;
              if (!s)
                return x.readTransaction(function(r) {
                  g._get(e, Vn.extend({ctx: r}, t), n);
                });
              var u,
                  c;
              t.rev ? (u = Nn(ci, [zo, Qo], zo + ".id=" + Qo + ".doc_id", [Qo + ".doc_id=?", Qo + ".rev=?"]), c = [e, t.rev]) : (u = Nn(ci, [zo, Qo], ui, zo + ".id=?"), c = [e]), s.executeSql(u, c, function(e, n) {
                if (!n.rows.length)
                  return a = A(fr, "missing"), r();
                var s = n.rows.item(0);
                return i = tn(s.metadata), s.deleted && !t.rev ? (a = A(fr, "deleted"), r()) : (o = Rn(s.data, i.id, s.rev), void r());
              });
            }, g._allDocs = function(e, t) {
              var n,
                  r = [],
                  ...
                  d = [];
              if (a !== !1)
                d.push(zo + ".id = ?"), l.push(a);
              else if (o !== !1 || i !== !1) {
                if (o !== !1 && (d.push(zo + ".id " + (s ? "<=" : ">=") + " ?"), l.push(o)), i !== !1) {
                  var h = s ? ">" : "<";
                  f && (h += "="), d.push(zo + ".id " + h + " ?"), l.push(i);
                }
                a !== !1 && (d.push(zo + ".id = ?"), l.push(a));
              }
              "ok" !== e.deleted && d.push(Qo + ".deleted = 0"), x.readTransaction(function(t) {
                y(t, function(o) {
                  if (n = o, 0 !== u) {
                    var i = Nn(ci, [zo, Qo], ui, d, zo + ".id " + (s ? "DESC" : "ASC"));
                    i += " LIMIT " + u + " OFFSET " + c, t.executeSql(i, l, function(t, n) {
                      for (var o = 0,
                        ...
                        if (e.include_docs && (l.doc = c, l.doc._rev = f, e.conflicts && (l.doc._conflicts = q(s)), Kn(l.doc, e, g, t)), a.deleted) {
                          if ("ok" !== e.deleted)
                            continue;
              ...
              function t() {
                var t = zo + ".json AS metadata, " + zo + ".max_seq AS maxSeq, " + Qo + ".json AS winningDoc, " + Qo + ".rev AS winningRev ",
                    n = zo + " JOIN " + Qo,
                    u = zo + ".id=" + Qo + ".doc_id AND " + zo + ".winningseq=" + Qo + ".seq",
                    c = ["maxSeq > ?"],
                    f = [e.since];
                e.doc_ids && (c.push(zo + ".id IN " + Dn(e.doc_ids.length)), f = f.concat(e.doc_ids));
                  ...
                  t.executeSql(d, f, function(t, n) {
                    ...
                    for (var u = 0,
                      ...
                      var f = n.rows.item(u),
                          l = tn(f.metadata);
                      p = f.maxSeq;
                      var d = Rn(f.winningDoc, l.id, f.winningRev),
                          v = e.processChange(d, l, e);
                      v.seq = f.maxSeq;
                      var y = h(v);
                      if ("object" == typeof y)
                        return e.complete(y);
                      if (y && (s++, i && a.push(v), e.attachments && e.include_docs ? Kn(d, e, g, t, r(v)) : r(v)()), s === o)
                        break;
                    }
                  });
                }, Fn(e.complete), function() {
              ...
              if (e = c(e), e.continuous) {
                var n = g._name + ":" + D();
                return Gn.Changes.addListener(g._name, n, g, e), Gn.Changes.notify(g._name), {cancel: function() {
                    Gn.Changes.removeListener(g._name, n);
                  }};
              }
              var r = e.descending;
              ...
              e();
            }, g._getAttachment = function(e, t, n) {
              var r,
                  o = t.ctx,
                  i = e.digest,
                  a = e.content_type,
                  s = "SELECT escaped, CASE WHEN escaped = 1 THEN body ELSE HEX(body) END AS body FROM " + $o + " WHERE digest=?";
              o.executeSql(s, [i], function(e, o) {
                var i = o.rows.item(0),
                    s = i.escaped ? Ln(i.body) : On(i.body, m);
                r = t.binary ? ye(s, a) : Vr(s), n(null, r);
              });
            }, g._getRevisionTree = function(e, t) {
              x.readTransaction(function(n) {
                var r = "SELECT json AS metadata FROM " + zo + " WHERE id = ?";
                n.executeSql(r, [e], function(e, n) {
                  if (n.rows.length) {
                    var r = tn(n.rows.item(0).metadata);
                    t(null, r.rev_tree);
                  } else
                    t(A(fr));
                });
              });
            }, g._doCompaction = function(e, t, n) {
              return t.length ? void x.transaction(function(n) {
                var r = "SELECT json AS metadata FROM " + zo + " WHERE id = ?";
                n.executeSql(r, [e], function(n, r) {
                  var o = tn(r.rows.item(0).metadata);
                  E(o.rev_tree, function(e, n, r, o, i) {
                    var a = n + "-" + r;
                    -1 !== t.indexOf(a) && (i.status = "missing");
                  });
                  var i = "UPDATE " + zo + " SET json = ? WHERE id = ?";
                  n.executeSql(i, [nn(o), e]);
                }), Bn(t, e, n);
              }, Fn(n), function() {
                n();
              }) : n();
            }, g._getLocal = function(e, t) {
              x.readTransaction(function(n) {
                var r = "SELECT json, rev FROM " + Yo + " WHERE id=?";
                n.executeSql(r, [e], function(n, r) {
                  if (r.rows.length) {
                    var o = r.rows.item(0),
                        i = Rn(o.json, e, o.rev);
            ...
            }, g._putLocal = function(e, t, n) {
              function r(e) {
                var r,
                    c;
                i ? (r = "UPDATE " + Yo + " SET rev=?, json=? WHERE id=? AND rev=?", c = [o, u, a, i]) : (r = "INSERT INTO " + Yo + " (id, rev, json) VALUES (?,?,?)", c = [a, o, u]), e.executeSql(r, c, function(e, r) {
                  r.rowsAffected ? (s = {
                    ok: !0,
                    id: a,
                    rev: o
                  }, t.ctx && n(null, s)) : n(A(lr));
                }, function() {
                  return n(A(lr)), !1;
                });
              }
              ...
              var s,
                  u = In(e);
              t.ctx ? r(t.ctx) : x.transaction(r, Fn(n), function() {
                s && n(null, s);
              });
            }, g._removeLocal = function(e, t, n) {
              function r(r) {
                var i = "DELETE FROM " + Yo + " WHERE id=? AND rev=?",
                    a = [e._id, e._rev];
            ...
            }, g._destroy = function(e, t) {
              Gn.Changes.removeAllListeners(g._name), x.transaction(function(e) {
                var t = [zo, Qo, $o, Zo, Yo, ei];
                t.forEach(function(t) {
                  e.executeSql("DROP TABLE IF EXISTS " + t, []);
                });
              }, Fn(t), function() {
                ne() && (delete window.localStorage["_pouch__websqldb_" + g._name], delete window.localStorage[g._name]), t(null, {ok: !0});
              });
            };
          }
          var Vn = e(7),
              ...
              or = o(e(15)),
              ir = o(e(16)),
              ar = "function" == typeof Promise ? Promise : nr,
              sr = Zn("pouchdb:api");
          zn(x, Error), x.prototype.toString = function() {
          ...
          var ur = new x({
            ...
            reason: "Name or password is incorrect."
              ...
              Ir = function(e, t, n) {
                var r = Object.keys(Lr).filter(function(n) {
                  var r = Lr[n];
          ...
          zn(O, $n.EventEmitter), O.prototype.cancel = function() {
            this.isCancelled = !0, this.db.taskqueue.isReady && this.emit("cancel");
          }, O.prototype.doChanges = function(e) {
            var t = this,
                n = e.complete;
            if (e = c(e), "live" in e && !("continuous" in e) && (e.continuous = e.live), e.processChange = j, "latest" === e.since && (e.since = "now"), e.since || (e.since = 0), "now" === e.since)
            ...
            if (e.continuous && "now" !== e.since && this.db.info().then(function(e) {
              ...
              if ("idbNull" !== e.id)
                throw e;
            }), e.filter && "string" == typeof e.filter && ("_view" === e.filter ? e.view = w(e.view) : e.filter = w(e.filter), "http" !== this.db.type() && !e.doc_ids))
            ...
            if (r && "function" == typeof r.cancel) {
              var o = t.cancel;
              t.cancel = Yn(function(e) {
                r.cancel(), o.apply(this, e);
              });
            }
          }, O.prototype.filterChanges = function(e) {
            var t = this,
                n = e.complete;
            if ("_view" === e.filter) {
              if (!e.view || "string" != typeof e.view) {
                var r = A(wr, "`view` filter parameter not found or invalid.");
                return n(r);
              }
              var o = b(e.view);
              this.db.get("_design/" + o[0], function(r, i) {
                ...
                return a ? (e.filter = g(a), void t.doChanges(e)) : n(A(fr, i.views ? "missing json key: " + o[1] : "missing json key: views"));
              });
            } else {
              var i = b(e.filter);
              if (!i)
              ...
              this.db.get("_design/" + i[0], function(r, o) {
                ...
                return a ? (e.filter = m(a), void t.doChanges(e)) : n(A(fr, o && o.filters ? "missing json key: " + i[1] : "missing json key: filters"));
              });
            }
          };
          var Rr = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
              Dr = N(["_id", "_rev", "_attachments", "_deleted", "_revisions", "_revs_info", "_conflicts", "_deleted_conflicts", "_local_seq", "_rev_tree", "_replication_id", "_replication_state", "_replication_state_time", "_replication_state_reason", "_replication_stats", "_removed"]),
              Nr = N(["_attachments", "_replication_id", "_replication_state", "_replication_state_time", "_replication_state_reason", "_replication_stats"]);
          zn(Q, $n.EventEmitter), Q.prototype.post = d("post", function(e, t, n) {
            return "function" == typeof t && (n = t, t = {}), "object" != typeof e || Array.isArray(e) ? n(A(Er)) : void this.bulkDocs({docs: [e]}, t, W(n));
          }), Q.prototype.put = d("put", Yn(function(e) {
            var t,
                n,
                r,
                o,
            ...
            if ("object" != typeof i || Array.isArray(i))
              return (o = e.pop())(A(Er));
            for (; ; )
              if (t = e.shift(), n = typeof t, "string" !== n || a ? "string" !== n || !a || "_rev" in i ? "object" === n ? r = t : "function" === n && (o = t) : i._rev = t : (i._id = t, a = !0), !e.length)
                break;
            return r = r || {}, B(i._id), L(i._id) && "function" == typeof this._putLocal ? i._deleted ? this._removeLocal(i, o) : this._putLocal(i, o) : void this.bulkDocs({docs: [i]}, r, W(o));
          })), Q.prototype.putAttachment = d("putAttachment", function(e, t, n, r, o, i) {
            function a(e) {
            ...
            return "function" == typeof o && (i = o, o = r, r = n, n = null), "undefined" == typeof o && (o = r, r = n, n = null), s.get(e).then(function(e) {
              ...
              if (t.reason === fr.message)
                return a({_id: e});
              throw t;
            });
          }), Q.prototype.removeAttachment = d("removeAttachment", function(e, t, n, r) {
            var o = this;
            o.get(e, function(e, i) {
              return e ? void r(e) : i._rev !== n ? void r(A(lr)) : i._attachments ? (delete i._attachments[t], 0 === Object.keys(i._attachments).length && delete i._attachments, void o.put(i, r)) : r();
            });
          }), Q.prototype.remove = d("remove", function(e, t, n, r) {
            var o;
            "string" == typeof t ? (o = {
              _id: e,
              _rev: t
            ...
            return i._deleted = !0, L(i._id) && "function" == typeof this._removeLocal ? this._removeLocal(o, r) : void this.bulkDocs({docs: [i]}, n, W(r));
          }), Q.prototype.revsDiff = d("revsDiff", function(e, t, n) {
            function r(e, t) {
              s.has(e) || s.set(e, {missing: []}), s.get(e).missing.push(t);
            }
            function o(t, n) {
              var o = e[t].slice(0);
              E(n, function(e, n, i, a, s) {
                var u = n + "-" + i,
                    c = o.indexOf(u);
          ...
          }), Q.prototype.bulkGet = d("bulkGet", function(e, t) {
            C(this, e, t);
          }), Q.prototype.compactDocument = d("compactDocument", function(e, t, n) {
            var r = this;
            this._getRevisionTree(e, function(o, i) {
              ...
              Object.keys(a).forEach(function(e) {
                a[e] > t && s.push(e);
              }), E(i, function(e, t, n, r, o) {
                var i = t + "-" + n;
                "available" === o.status && -1 !== s.indexOf(i) && u.push(i);
              }), r._doCompaction(e, u, n);
            });
          }), Q.prototype.compact = d("compact", function(e, t) {
            "function" == typeof e && (t = e, e = {});
            var n = this;
            e = e || {}, n._compactionQueue = n._compactionQueue || [], n._compactionQueue.push({
              opts: e,
              callback: t
            }), 1 === n._compactionQueue.length && X(n);
          }), Q.prototype._compact = function(e, t) {
            function n(e) {
              a.push(o.compactDocument(e.id, 0));
            }
            function r(e) {
              var n = e.last_seq;
              ar.all(a).then(function() {
                return h(o, "_local/compaction", function(e) {
          ...
          }, Q.prototype.get = d("get", function(e, t, n) {
            function r() {
              var r = [],
                  a = o.length;
              return a ? void o.forEach(function(o) {
                i.get(e, {
                  ...
                  e ? r.push({missing: o}) : r.push({ok: t}), a--, a || n(null, r);
                });
              }) : n(null, r);
            }
            if ("function" == typeof t && (n = t, t = {}), "string" != typeof e)
              return n(A(dr));
            if (L(e) && "function" == typeof this._getLocal)
            ...
            if (!t.open_revs)
              return this._get(e, t, function(e, r) {
                ...
                if (_(a, o._rev) && (o._deleted = !0), t.revs || t.revs_info) {
                  var c = I(a.rev_tree),
                      f = H(c, function(e) {
                ...
                if (t.attachments && o._attachments) {
                  ...
                  if (o._attachments)
                    for (var y in o._attachments)
                      o._attachments.hasOwnProperty(y) && (o._attachments[y].stub = !0);
                  n(null, o);
                }
              });
            if ("all" === t.open_revs)
              this._getRevisionTree(e, function(e, t) {
                return e ? n(e) : (o = k(t).map(function(e) {
                  return e.rev;
                }), void r());
              });
            else {
              if (!Array.isArray(t.open_revs))
                return n(A(yr, "function_clause"));
              o = t.open_revs;
          ...
          }), Q.prototype.getAttachment = d("getAttachment", function(e, t, n, r) {
            var o = this;
            n instanceof Function && (r = n, n = {}), this._get(e, n, function(e, i) {
              return e ? r(e) : i.doc._attachments && i.doc._attachments[t] ? (n.ctx = i.ctx, n.binary = !0, o._getAttachment(i.doc._attachments[t], n, r), void 0) : r(A(fr));
            });
          }), Q.prototype.allDocs = d("allDocs", function(e, t) {
            if ("function" == typeof e && (t = e, e = {}), e.skip = "undefined" != typeof e.skip ? e.skip : 0, e.start_key && (e.startkey = e.start_key), e.end_key && (e.endkey = e.end_key), "keys" in e) {
              ...
              if (n)
                return void t(A(gr, "Query parameter `" + n + "` is not compatible with multi-get"));
              if ("http" !== this.type())
                return V(this, e, t);
            }
            return this._allDocs(e, t);
          }), Q.prototype.changes = function(e, t) {
            return "function" == typeof e && (t = e, e = {}), new O(this, e, t);
          }, Q.prototype.close = d("close", function(e) {
            return this._closed = !0, this._close(e);
          }), Q.prototype.info = d("info", function(e) {
            var t = this;
            ...
            }), o ? n(A(wr, o)) : ("new_edits" in t || ("new_edits" in e ? t.new_edits = e.new_edits : t.new_edits = !0), t.new_edits || "http" === this.type() || e.docs.sort(K), J(e.docs), this._bulkDocs(e, t, function(e, r) {
              return e ? n(e) : (t.new_edits || (r = r.filter(function(e) {
                return e.error;
              })), void n(null, r));
            }));
          }), Q.prototype.registerDependentDatabase = d("registerDependentDatabase", function(e, t) {
            function n(t) {
              return t.dependentDbs = t.dependentDbs || {}, t.dependentDbs[e] ? !1 : (t.dependentDbs[e] = !0, t);
            }
            var r = new this.constructor(e, this.__opts);
            h(this, "_local/_pouch_dependentDbs", n).then(function() {
              t(null, {db: r});
            })["catch"](t);
          }), Q.prototype.destroy = d("destroy", function(e, t) {
            function n() {
          ...
          }, $.prototype.ready = function(e) {
            this.isReady = !0, this.db = e, this.execute();
          }, $.prototype.addTask = function(e) {
          ...
          ee.adapters = {}, ee.preferredAdapters = [], ee.prefix = "_pouch_";
          var Mr = new $n.EventEmitter;
          re(ee), ee.parseAdapter = function(e, t) {
            var n,
                r,
                o = e.match(/([a-z\-]*):\/\/(.*)/);
            if (o) {
              if (e = /http(s?)/.test(o[1]) ? o[1] + "://" + o[2] : o[2], n = o[1], !ee.adapters[n].valid())
            ...
            var i = "idb" in ee.adapters && "websql" in ee.adapters && ne() && localStorage["_pouch__websqldb_" + ee.prefix + e];
            if (t.adapter)
              r = t.adapter;
            else if ("undefined" != typeof t && t.db)
              r = "leveldb";
            else
              for (var a = 0; a < ee.preferredAdapters.length; ++a)
                if (r = ee.preferredAdapters[a], r in ee.adapters) {
                  if (i && "idb" === r) {
            ...
            return {
              name: s ? ee.prefix + e : e,
              adapter: r
            };
          }, ee.adapter = function(e, t, n) {
            t.valid() && (ee.adapters[e] = t, n && ee.preferredAdapters.push(e));
          }, ee.plugin = function(e) {
            return Object.keys(e).forEach(function(t) {
              ee.prototype[t] = e[t];
            }), ee;
          }, ee.defaults = function(e) {
            function t(n, r, o) {
              return this instanceof t ? (("function" == typeof r || "undefined" == typeof r) && (o = r, r = {}), n && "object" == typeof n && (r = n, n = void 0), r = Vn.extend({}, e, r), void ee.call(this, n, r, o)) : new t(n, r, o);
            }
            return zn(t, ee), re(t), t.preferredAdapters = ee.preferredAdapters.slice(), Object.keys(ee).forEach(function(e) {
              e in t || (t[e] = ee[e]);
            }), t;
          };
          var Ur = ce(),
              ...
              Zr = 5,
              eo = 0;
          we.prototype.writeCheckpoint = function(e, t) {
            var n = this;
            return this.updateTarget(e, t).then(function() {
              return n.updateSource(e, t);
            });
          }, we.prototype.updateTarget = function(e, t) {
            return be(this.target, this.id, e, t, this.returnValue);
          }, we.prototype.updateSource = function(e, t) {
            var n = this;
            return this.readOnlySource ? ar.resolve(!0) : be(this.src, this.id, e, t, this.returnValue)["catch"](function(e) {
              if (qe(e))
          ...
          var to = {
            undefined: function(e, t) {
              return 0 === Qr(e.last_seq, t.last_seq) ? t.last_seq : 0;
            },
            1: function(e, t) {
              return Ee(t, e).last_seq;
            }
          };
          we.prototype.getCheckpoint = function() {
            var e = this;
            return e.target.get(e.id).then(function(t) {
              return e.readOnlySource ? ar.resolve(t.last_seq) : e.src.get(e.id).then(function(e) {
                if (t.version !== e.version)
                  return eo;
                var n;
                return n = t.version ? t.version.toString() : "undefined", n in to ? to[n](t, e) : eo;
              }, function(n) {
                if (404 === n.status && t.last_seq)
                  return e.src.put({
                    ...
                    return qe(n) ? (e.readOnlySource = !0, t.last_seq) : eo;
                  });
                throw n;
              });
            })["catch"](function(e) {
          ...
          var no = 0,
              ro = r.setImmediate || r.setTimeout,
              oo = 32768,
              io = l(function(e, t) {
                function n() {
                  var r = s * i,
                ...
                var r = "string" == typeof e,
                    ...
                    a = Math.ceil(o / i),
                    s = 0,
                    u = r ? new or : new or.ArrayBuffer,
                    c = r ? Ce : je;
                n();
              });
          zn(Fe, $n.EventEmitter), Fe.prototype.cancel = function() {
            this.cancelled = !0, this.state = "cancelled", this.emit("cancel");
          }, Fe.prototype.ready = function(e, t) {
            function n() {
              o.cancel();
            }
            function r() {
          ...
          var ao = {
            ...
            toPouch: Me
              ...
              so = ao.replicate;
          zn(He, $n.EventEmitter), He.prototype.cancel = function() {
          ...
          var po,
              ...
              yo = function(e) {
                return Yn(function(t) {
                  var n = t.pop(),
                      r = e.apply(this, t);
                  return "function" == typeof n && vo(r, n), r;
                });
              },
              _o = function(e, t) {
              ...
              wo = tr.collate,
              Eo = tr.toIndexableString,
              So = tr.normalizeKey,
              ko = tr.parseIndexableString;
          po = "undefined" != typeof console && "function" == typeof console.log ? Function.prototype.bind.call(console.log, console) : function() {};
          var qo = bo.callbackify,
              xo = bo.sequentialize,
              Ao = bo.uniq,
              To = bo.fin,
              Oo = bo.promisedCallback,
              jo = {},
              Co = new nt,
              Lo = 50,
              Io = {
              ...
              Ro = qo(function() {
                var e = this;
                return "http" === e.type() ? Rt(e) : "function" == typeof e._viewCleanup ? kt(e) : Dt(e);
              }),
              Do = function(e, t, n) {
                "function" == typeof t && (n = t, t = {}), t = t ? gt(t) : {}, "function" == typeof e && (e = {map: e});
                var r = this,
                    o = ar.resolve().then(function() {
                      return Nt(r, e, t);
                    });
                return Oo(o, n), o;
              };
          zn(Bt, Error), zn(Ft, Error), zn(Mt, Error);
          var No = {
            query: Do,
            viewCleanup: Ro
          },
              ...
              Ho = "meta-store",
              Wo = "local-store",
              Jo = "detect-blob-support",
              Ko = {
                running: !1,
                queue: []
              };
          zn(wn, $n.EventEmitter), wn.prototype.addListener = function(e, t, n, r) {
            function o() {
              function e() {
                s = !1;
              }
              if (a._listeners[t]) {
                ...
                s = !0;
                var u = i(r, ["style", "include_docs", "attachments", "conflicts", "filter", "doc_ids", "view", "since", "query_params", "binary"]);
                n.changes(u).on("change", function(e) {
            ...
            t in this._listeners && $n.EventEmitter.prototype.removeListener.call(this, e, this._listeners[t]);
          }, wn.prototype.notifyLocalWindows = function(e) {
            te() ? chrome.storage.local.set({dbName: e}) : ne() && (localStorage[e] = "a" === localStorage[e] ? "b" : "a");
          }, wn.prototype.notify = function(e) {
          ...
          var Xo = 7,
              zo = jn("document-store"),
              Qo = jn("by-sequence"),
              $o = jn("attach-store"),
              Yo = jn("local-store"),
              Zo = jn("metadata-store"),
              ei = jn("attach-seq-store"),
              ti = {},
              ni = 1,
              ri = "CREATE INDEX IF NOT EXISTS 'by-seq-deleted-idx' ON " + Qo + " (seq, deleted)",
              oi = "CREATE UNIQUE INDEX IF NOT EXISTS 'by-seq-doc-id-rev' ON " + Qo + " (doc_id, rev)",
              ii = "CREATE INDEX IF NOT EXISTS 'doc-winningseq-idx' ON " + zo + " (winningseq)",
              ai = "CREATE INDEX IF NOT EXISTS 'attach-seq-seq-idx' ON " + ei + " (seq)",
              si = "CREATE UNIQUE INDEX IF NOT EXISTS 'attach-seq-digest-idx' ON " + ei + " (digest, seq)",
              ui = Qo + ".seq = " + zo + ".winningseq",
              ci = Qo + ".seq AS seq, " + Qo + ".deleted AS deleted, " + Qo + ".json AS data, " + Qo + ".rev AS rev, " + zo + ".json AS metadata";
          Gn.valid = Wn, Gn.Changes = new wn;
          var fi = {
            idb: En,
            websql: Gn
          };
          ee.ajax = he, ee.utils = zr, ee.Errors = Lr, ee.replicate = ao.replicate, ee.sync = Pe, ee.version = "5.2.1", ee.adapter("http", tt), ee.adapter("https", tt), ee.plugin(No), Object.keys(fi).forEach(function(e) {
            ee.adapter(e, fi[e], !0);
          }), t.exports = ee;
