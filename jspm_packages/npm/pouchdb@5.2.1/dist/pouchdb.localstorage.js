  ...
  (function e(t, n, r) {
    ...
    1: [function(_dereq_, module, exports) {
      (function(process, global, Buffer) {
        ...
        var downAdapter = _interopDefault(_dereq_(59));
        var jsExtend = _dereq_(24);
        var levelup = _interopDefault(_dereq_(46));
        var sublevel = _interopDefault(_dereq_(32));
        var through2 = _dereq_(95);
        var collections = _interopDefault(_dereq_(66));
        ...
        var vuvuzela = _interopDefault(_dereq_(100));
        var Md5 = _interopDefault(_dereq_(76));
        var lie = _interopDefault(_dereq_(58));
      ...
      }).call(this, _dereq_(68), typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, _dereq_(8).Buffer);
    }, {
      "100": 100,
      "12": 12,
      "15": 15,
    ...
    4: [function(_dereq_, module, exports) {
      ...
      }).call(this, {"isBuffer": _dereq_(22)}, _dereq_(68));
    }, {
      "101": 101,
      "2": 2,
      "22": 22,
    ...
    17: [function(_dereq_, module, exports) {
      (function(global) {
        ...
        var localStorageMemory = _dereq_(64);
        exports.hasLocalStorage = _dereq_(16);
    ...
    28: [function(_dereq_, module, exports) {
      ...
      var extend = _dereq_(29);
      var EncodingError = _dereq_(27).EncodingError;
    ...
    32: [function(_dereq_, module, exports) {
      var nut = _dereq_(41);
      var shell = _dereq_(44);
      var codec = _dereq_(33);
      var merge = _dereq_(40);
      var ReadStream = _dereq_(36);
      var precodec = _dereq_(30);
    ...
    36: [function(_dereq_, module, exports) {
      var Readable = _dereq_(75).Readable,
          ...
          extend = _dereq_(38),
          EncodingError = _dereq_(35).EncodingError,
          util = _dereq_(37);
    ...
    44: [function(_dereq_, module, exports) {
      (function(process) {
        ...
        var addpre = _dereq_(43).addPrefix;
        var errors = _dereq_(35);
        function isFunction(f) {
          return 'function' === typeof f;
        }
        function isString(s) {
        ...
        var version = _dereq_(42).version;
    ...
    45: [function(_dereq_, module, exports) {
      var util = _dereq_(47),
          WriteError = _dereq_(27).WriteError,
    ...
    46: [function(_dereq_, module, exports) {
      (function(process) {
        var EventEmitter = _dereq_(15).EventEmitter,
            ...
            extend = _dereq_(56),
            prr = _dereq_(55),
            DeferredLevelDOWN = _dereq_(54),
            IteratorStream = _dereq_(28),
            errors = _dereq_(27),
        ...
        module.exports.errors = _dereq_(27);
    ...
    47: [function(_dereq_, module, exports) {
      var extend = _dereq_(56),
          LevelUPError = _dereq_(27).LevelUPError,
      ...
      function getLevelDOWN() {
        if (leveldown)
          return leveldown;
        var requiredVersion = _dereq_(57).devDependencies.leveldown,
            leveldownVersion;
        try {
          leveldownVersion = _dereq_(7).version;
        } catch (e) {
    ...
    59: [function(_dereq_, module, exports) {
      (function(process, global, Buffer) {
        ...
        var LocalStorage = _dereq_(61).LocalStorage;
        var LocalStorageCore = _dereq_(60);
    ...
    70: [function(_dereq_, module, exports) {
      (function(process) {
        ...
        var Readable = _dereq_(72);
        var Writable = _dereq_(74);
    ...
    75: [function(_dereq_, module, exports) {
      var Stream = _dereq_(77);
      exports = module.exports = _dereq_(72);
      exports.Stream = Stream;
      exports.Readable = exports;
      exports.Writable = _dereq_(74);
      exports.Duplex = _dereq_(70);
      exports.Transform = _dereq_(73);
      exports.PassThrough = _dereq_(71);
    }, {
      "70": 70,
      "71": 71,
      "72": 72,
    ...
    79: [function(_dereq_, module, exports) {
      ...
      module.exports = Duplex;
      var processNextTick = _dereq_(67);
      var util = _dereq_(10);
      util.inherits = _dereq_(21);
