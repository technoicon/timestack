  ...
  (function e(t, n, r) {
    ...
    1: [function(_dereq_, module, exports) {
      (function(process, global, Buffer) {
        ...
        var downAdapter = _interopDefault(_dereq_(54));
        var jsExtend = _dereq_(18);
        var levelup = _interopDefault(_dereq_(40));
        var sublevel = _interopDefault(_dereq_(26));
        var through2 = _dereq_(91);
        var collections = _interopDefault(_dereq_(62));
        var getArguments = _interopDefault(_dereq_(2));
        var Deque = _interopDefault(_dereq_(8));
        var events = _dereq_(11);
        var inherits = _interopDefault(_dereq_(15));
      ...
      }).call(this, _dereq_(64), typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, _dereq_(5).Buffer);
    }, {
      "11": 11,
      "15": 15,
      "18": 18,
    ...
    10: [function(_dereq_, module, exports) {
      ...
      module.exports.custom = _dereq_(9)(module.exports);
    ...
    21: [function(_dereq_, module, exports) {
      var createError = _dereq_(10).create,
    ...
    22: [function(_dereq_, module, exports) {
      var inherits = _dereq_(15);
      var Readable = _dereq_(71).Readable;
      var extend = _dereq_(23);
      var EncodingError = _dereq_(21).EncodingError;
    ...
    26: [function(_dereq_, module, exports) {
      var nut = _dereq_(35);
      var shell = _dereq_(38);
      var codec = _dereq_(27);
      var merge = _dereq_(34);
      var ReadStream = _dereq_(30);
      var precodec = _dereq_(24);
    ...
    30: [function(_dereq_, module, exports) {
      var Readable = _dereq_(71).Readable,
          ...
          extend = _dereq_(32),
          EncodingError = _dereq_(29).EncodingError,
          util = _dereq_(31);
    ...
    31: [function(_dereq_, module, exports) {
      ...
      function getLevelDOWN() {
        if (leveldown)
          return leveldown;
        var requiredVersion = _dereq_(33).devDependencies.leveldown,
    ...
    38: [function(_dereq_, module, exports) {
      (function(process) {
        var EventEmitter = _dereq_(11).EventEmitter;
        var addpre = _dereq_(37).addPrefix;
        ...
        var version = _dereq_(36).version;
    ...
    39: [function(_dereq_, module, exports) {
      var util = _dereq_(41),
          WriteError = _dereq_(21).WriteError,
    ...
    40: [function(_dereq_, module, exports) {
      (function(process) {
        var EventEmitter = _dereq_(11).EventEmitter,
            ...
            extend = _dereq_(50),
            prr = _dereq_(49),
            DeferredLevelDOWN = _dereq_(48),
            IteratorStream = _dereq_(22),
            errors = _dereq_(21),
        ...
        module.exports.errors = _dereq_(21);
    ...
    41: [function(_dereq_, module, exports) {
      var extend = _dereq_(50),
          LevelUPError = _dereq_(21).LevelUPError,
    ...
    44: [function(_dereq_, module, exports) {
      (function(Buffer, process) {
        var xtend = _dereq_(50),
            AbstractIterator = _dereq_(43),
            AbstractChainedBatch = _dereq_(42);
      ...
      }).call(this, {"isBuffer": _dereq_(16)}, _dereq_(64));
    }, {
      "16": 16,
      "42": 42,
      "43": 43,
    ...
    45: [function(_dereq_, module, exports) {
      exports.AbstractLevelDOWN = _dereq_(44);
      exports.AbstractIterator = _dereq_(43);
      exports.AbstractChainedBatch = _dereq_(42);
      exports.isLevelDOWN = _dereq_(46);
    }, {
      "42": 42,
      "43": 43,
      "44": 44,
    ...
    46: [function(_dereq_, module, exports) {
      var AbstractLevelDOWN = _dereq_(44);
    ...
    47: [function(_dereq_, module, exports) {
      var util = _dereq_(94),
          AbstractIterator = _dereq_(45).AbstractIterator;
    ...
    48: [function(_dereq_, module, exports) {
      (function(Buffer, process) {
        var util = _dereq_(94),
            AbstractLevelDOWN = _dereq_(45).AbstractLevelDOWN,
            DeferredIterator = _dereq_(47);
      ...
      (function(process, global, Buffer) {
        ...
        MemDOWN.prototype._batch = function(array, options, callback) {
          ...
          while (++i < len) {
            ...
            if (err)
              return setImmediate(function errorCall() {
                callback(err);
              });
            iter = tree.find(key);
            if (array[i].type === 'put') {
      ...
      (function(process) {
        ...
        (function() {
          try {
            ...
            if (!Stream)
              Stream = _dereq_(11).EventEmitter;
          }
        }());
        var Buffer = _dereq_(5).Buffer;
        var util = _dereq_(7);
    ...
    79: [function(_dereq_, module, exports) {
      ...
      var util = _dereq_(7);
      util.inherits = _dereq_(15);
      var internalUtil = {deprecate: _dereq_(92)};
      var Stream;
      (function() {
        try {
          Stream = _dereq_('st' + 'ream');
