...
var expected = [[[], 'foo'], [['foo'], 'bar'], [['foo', 'bar'], 'baz'], [['foo', 'bar'], 'blerg'], [['foobar'], 'barbaz']];
...
module.exports = function(format) {
  ...
  tape('ordering', function(t) {
    ...
    var actual = expected.slice().sort(random).map(format.encode).sort().map(format.decode);
    console.log(actual);
...
module.exports(require('../codec/index'));
