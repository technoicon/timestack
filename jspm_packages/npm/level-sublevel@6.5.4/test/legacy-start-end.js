...
[mainDB, subDB].forEach(function(db, i) {
  ...
  test('legacy start/end/reverse: ' + testName, function(t) {
    db.batch(batch, function(err) {
      t.notOk(err);
      var i = -1;
      var testCases = [[{start: 'b'}, ['b', 'c', 'd', 'e']], [{
        start: 'b',
        end: 'd'
      }, ['b', 'c', 'd']], [{start: 'a'}, ['a', 'b', 'c', 'd', 'e']], [{start: 'e'}, ['e']], [{start: '0'}, ['a', 'b', 'c', 'd', 'e']], [{start: 'z'}, []], [{end: 'c'}, ['a', 'b', 'c']], [{end: 'a'}, ['a']], [{end: 'e'}, ['a', 'b', 'c', 'd', 'e']], [{end: '0'}, []], [{end: 'z'}, ['a', 'b', 'c', 'd', 'e']], [{
        start: 'd',
        end: 'b',
        reverse: true
      }, ['d', 'c', 'b']], [{
  ...
  test('modern start/end/reverse: ' + testName, function(t) {
    db.batch(batch, function(err) {
      t.notOk(err);
      var i = -1;
      var testCases = [[{gte: 'b'}, ['b', 'c', 'd', 'e']], [{
        gte: 'b',
        lte: 'd'
      }, ['b', 'c', 'd']], [{gte: 'a'}, ['a', 'b', 'c', 'd', 'e']], [{gte: 'e'}, ['e']], [{gte: '0'}, ['a', 'b', 'c', 'd', 'e']], [{gte: 'z'}, []], [{lte: 'c'}, ['a', 'b', 'c']], [{lte: 'a'}, ['a']], [{lte: 'e'}, ['a', 'b', 'c', 'd', 'e']], [{lte: '0'}, []], [{lte: 'z'}, ['a', 'b', 'c', 'd', 'e']], [{
        lte: 'd',
        gte: 'b',
        reverse: true
      }, ['d', 'c', 'b']], [{
