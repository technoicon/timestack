...
(function(Buffer, process) {
  ...
  module.exports.iterator = function(leveldown, test, testCommon, collectEntries) {
    ...
    testIteratorCollectsFullDatabase('test iterator with start as empty string', {gte: ''});
    testIteratorCollectsFullDatabase('test iterator with start as null', {gte: null});
    testIteratorCollectsFullDatabase('test iterator with end as empty string', {lte: ''});
    testIteratorCollectsFullDatabase('test iterator with end as null', {lte: null});
  };
