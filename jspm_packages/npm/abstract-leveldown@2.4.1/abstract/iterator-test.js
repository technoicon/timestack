...
(function(Buffer, process) {
  ...
  module.exports.args = function(test) {
    test('test argument-less iterator#next() throws', function(t) {
      ...
      t.throws(iterator.next.bind(iterator), {
        name: 'Error',
        message: 'next() requires a callback argument'
    ...
    test('test argument-less iterator#end() after next() throws', function(t) {
      ...
      iterator.next(function() {
        t.throws(iterator.end.bind(iterator), {
          name: 'Error',
          message: 'end() requires a callback argument'
  ...
  module.exports.iterator = function(leveldown, test, testCommon, collectEntries) {
    ...
    if (!process.browser) {
      testIteratorCollectsFullDatabase('test iterator with start as empty buffer', {start: new Buffer(0)});
      testIteratorCollectsFullDatabase('test iterator with end as empty buffer', {end: new Buffer(0)});
    }
    testIteratorCollectsFullDatabase('test iterator with start as empty string', {start: ''});
    testIteratorCollectsFullDatabase('test iterator with start as null', {start: null});
    testIteratorCollectsFullDatabase('test iterator with end as empty string', {end: ''});
    testIteratorCollectsFullDatabase('test iterator with end as null', {end: null});
  };
