...
(function(process) {
  var test = require('tape'),
      ...
      AbstractLevelDOWN = require('./index').AbstractLevelDOWN,
      AbstractIterator = require('./index').AbstractIterator,
      AbstractChainedBatch = require('./index').AbstractChainedBatch,
      isLevelDOWN = require('./index').isLevelDOWN;
